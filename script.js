(() => {
  ...
  const docs = {
    ...
    mahmoud: { name: { ar: "د. محمود صبري", en: "Dr. Mahmoud S.", he: "ד״ר מחמוד ס." }, img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop&crop=faces", status: "online" }
  };
  ...
  const seedReviews = [
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "زائر مهتم", en: "Visitor" }, text: { ar: "سؤال مهم جداً، ننتظر الإجابة الطبية." } },
        { name: { ar: "متابع", en: "Follower" }, text: { ar: "نفس التخوف بخصوص أدوية الأوعية الدموية." } },
        { name: { ar: "مريض ضغط سابق", en: "Patient" }, text: { ar: "ياليت الأطباء يوضحون الآلية بشكل دقيق." } },
        { ...docs.tariq, text: { ar: "أهلاً بكم جميعا. لا تقلقوا أبداً، تركيبة 'رايز' صُممت كعلاج موضعي خارجي لا يدخل في مجرى الدم الكلي، لذلك هي آمنة تماماً لمرضى الضغط." } },
    ...
    { 
      ...
      stars: 4, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "هل مرضى السكر يستجيبون بالسرعة المطلوبة؟" } },
        { name: { ar: "مهتم بالمنتج", en: "Interested" }, text: { ar: "كم تستغرق النظرة العلاجية للسكري؟" } },
        { ...docs.rami, text: { ar: "حياك الله. نعم فعال جداً. مرضى السكري يعانون من ضعف التروية الدموية الطرفية، ورايز يعمل موضعياً لتنشيط التدفق الدموي فوراً." } },
        { ...docs.mahmoud, text: { ar: "بالتأكيد، أنصحك بالالتزام بالتدليك الجيد لمدة دقيقة لتحقيق أقصى استجابة." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "متابع", en: "Follower" }, text: { ar: "هل النتيجة مستمرة مع تكرار الاستخدام؟" } },
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "وهل هناك أي آثار لاحقة؟" } },
        { ...docs.tariq, text: { ar: "نحمد الله أن النتيجة نالت رضاكم، ونؤكد استقرار الفعالية مع الاستخدام الصحيح." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "هذا أكبر عائق نخافه من البخاخات التقليدية." } },
        { name: { ar: "مهتم", en: "Interested" }, text: { ar: "هل الإحساس يبقى طبيعي 100%؟" } },
        { ...docs.mahmoud, text: { ar: "هذا اعتقاد خاطئ شائع بسبب البخاخات التجارية القديمة. رايز لا يحتوي على مخدر موضعي بل يعتمد على التنشيط الذكي للتروية دون فقدان الإحساس الطبيعي." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "سؤال يهم الجميع بخصوص التوقيت." } },
        { name: { ar: "متابع", en: "Follower" }, text: { ar: "هل يترك أثراً ظاهراً؟" } },
        { ...docs.tariq, text: { ar: "المفعول الفعلي يبدأ خلال 15 دقيقة ويمتد لساعات. ولا داعي لغسله أبداً لأن الجلد يمتصه بالكامل." } },
    ...
    { 
      ...
      stars: 5, 
      replies: [
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "كم استغرق وقت الشحن لديكم؟" } },
        { name: { ar: "متابع", en: "Follower" }, text: { ar: "وهل التغليف كان سرياً حقاً؟" } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "هذا هاجس طبيعي للمنتجات الطبية." } },
        { name: { ar: "مهتم", en: "Interested" }, text: { ar: "نرجو التوضيح العلمي من الفريق الطبي." } },
        { ...docs.rami, text: { ar: "التركيبة آمنة للاستخدام المتكرر ولا تسبب أي إدمان عضوي أو تعود وظائفي نهائياً." } },
        { ...docs.mahmoud, text: { ar: "يمكنك إيقافه متى شئت دون أي تأثير سلبي." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "سؤال يهم كبار السن كثيراً." } },
    ...
    { 
      ...
      stars: 5, 
      replies: [
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "شكراً على نقل التجربة الواقعية." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "هذه الأعراض مزعجة جداً في المنتجات التقليدية." } },
    ...
    { 
      ...
      stars: 4, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "نقطة الرائحة مهمة جداً للاستخدام المريح." } },
        { ...docs.rami, text: { ar: "التركيبة خالية تماماً من العطور النفاذة وتتبخر فور الامتصاص الجلدي." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "الخصوصية هي المعيار الأهم لدينا." } },
        { ...docs.tariq, text: { ar: "نلتزم بسرية تامة مطلقة. الشحنة تغلف بكيس أسود مبهم تماماً والمندوب لا يعلم محتواها." } }
      ] 
    },
    { 
    ...
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "هل يطلب الصيدلي أو المندوب أي تقرير؟" } },
        { ...docs.mahmoud, text: { ar: "لا، المنتج مصنف كمستحضر عناية طبية شخصية ولا يتطلب وصفة طبية." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "نفس المعاناة نرجو الإفادة الطبية." } },
    ...
    { 
      ...
      stars: 4, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "سؤال ممتاز بخصوص الجدوى الاقتصادية." } },
        { ...docs.rami, text: { ar: "تحتاج لكمية بحجم حبة البازلاء فقط، لذا تكفي العبوة حتى 30 استخداماً كاملاً." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "بعض الكريمات تسبب تهيجاً واضحاً." } },
        { ...docs.mahmoud, text: { ar: "لا يوجد أي لسع أو تهيج، المكونات مختبرة طبياً لتكون لطيفة جداً." } }
      ] 
    },
    { 
    ...
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "هل شروط الاسترداد معقدة؟" } },
    ...
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "زائر", en: "Visitor" }, text: { ar: "نقطة بالغة الأهمية للأمان الأسري." } },
        { ...docs.rami, text: { ar: "مطلقاً، شريطة الالتزام بفترة الانتظار (15 دقيقة) حتى يتم الامتصاص الجلدي التام." } }
      ] 
    },
    { 
    ...
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.mahmoud, text: { ar: "نعم، المنتج مرخص ومطابق لمعايير الجودة والسلامة الصحية المعتمدة." } }
      ] 
    }
  ];
