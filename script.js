(() => {
  ...
  const seedReviews = [
    { name: "خالد عبدالرحمن", text: { ar: "نتيجة خرافية من أول استخدام، انصح فيه وبشدة! فعلاً غير حياتي للأفضل.", en: "Amazing result from first use!", he: "תוצאה מדהימה מהשימוש הראשון!" }, stars: 5 },
    { name: "سالم المري", text: { ar: "التوصيل كان سريع جداً والمنتج فعاليته ممتازة وبدون أي تخدير، شكراً لكم من القلب." }, stars: 5 },
    ...
    { name: "سعد الشهراني", text: { ar: "المنتج رائع لكن تأخر المندوب نص يوم، بس للأمانة النتيجة نسّتني التأخير." }, stars: 4 },
    ...
    { name: "ماجد التميمي", text: { ar: "أعطيه 4 نجوم بسبب السعر شوي مرتفع، لكن المفعول يغطي على السعر بصراحة." }, stars: 4 },
  ...
  // === نصوص الواتساب العائمة (WhatsApp Floating Messages) ===
  const waMessages = {
    ar: "مرحباً مركز الارتقاء الطبي. مهتم جداً بمنتج 'رايز' وأريد الاستفادة من عروض اليوم. أرجو التواصل معي لتأكيد الطلب بسرية تامة.",
    en: "Hello Medical Elevation Center. I am very interested in the Rise product and want to benefit from today's offers. Please contact me to confirm the order with complete privacy.",
    he: "שלום מרכז העלייה הרפואי. אני מאוד מעוניין במוצר Rise ורוצה לנצל את המבצעים של היום. אנא צור איתי קשר לאישור ההזמנה בפרטיות מלאה."
  };
  ...
  const setLang = (lang) => {
    ...
    // تحديث رابط الواتساب بالرسالة المخصصة حسب اللغة المحددة
    const waBtn = document.getElementById('waFloatBtn');
    if (waBtn) {
      const msg = encodeURIComponent(waMessages[lang] || waMessages['ar']);
      waBtn.href = `https://wa.me/972512865105?text=${msg}`;
    }
