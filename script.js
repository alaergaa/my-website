(() => {
  ...
  const dict = {
    ...
    footerInfo: {
      ...
      he: `<div class="fc-welcome">אנחנו כאן בשבילך, מספקים שירותי בריאות הראויים לאמון שלך.</div><p>📍 <strong>מטה:</strong> עומאן - מוסקט, רחוב סולטאן קאבוס.</p><p>📞 <strong>וואטסאפ:</strong> <span style="direction:ltr; display:inline-block;">+972512865105</span></p><p>🕒 <strong>שעות פעילות:</strong> 07:00 - 19:00 (שישי סגור)</p>`
    },
    faqHtml: {
