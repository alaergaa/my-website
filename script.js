(() => {
  ...
  const dict = {
    ...
    aboutHtml: {
      ...
      en: `<p class="richIntro">Medical Elevation Center in Oman is a specialized medical institution dedicated to men's health. Call: +972512865105</p>`,
      he: `<p class="richIntro">מרכז העלייה הרפואי בעומאן הוא מוסד רפואי מתמחה. צור קשר: +972512865105</p>`
    },
    footerInfo: {
    ...
    faqHtml: {
      ar: `<div class='faq-list'>
            ...
            <div class='faq-item is-open'>
              ...
              <div class='faq-a'><p>نعم بكل تأكيد. نظراً لأنه علاج موضعي خارجي، فهو لا يتعارض مع أدوية السكري أو الضغط، يعتبر البديل الطبي الأكثر أماناً.</p></div>
            </div>
            <div class='faq-item is-open'>
    ...
    secReviewsTitle: { ar: "آراء العملاء والاستشارات الطبية", en: "Customer reviews & medical consults", he: "חוות דעת והתייעצויות רפואיות" },
    ...
    refundNeedFields: { ar: "يرجى تعبئة الحقول المطلوبة وإرفاق صور.", en: "Please fill required fields and attach photos.", he: "אנא מלאו את השדות הנדרשים وצרפו תמונות." },
    refundSuccess: { ar: "تم استلام طلب الاسترداد ✅", en: "Refund request received ✅", he: "בקשת ההחזר התקבלה ✅" },
    offersTitle: { ar: "عروض اليوم", en: "Today's offers", he: "מבצעي היום" },
    ...
    successFeature2: { ar: "🚚 شحن سريع وسري", en: "🚚 Fast & Discreet Shipping", he: "🚚 משלוח מהיר وדיسקרטי" },
  ...
  const docs = {
    tariq: { name: { ar: "د. طارق عبدالرحمن", en: "Dr. Tariq A.", he: "ד״ר טארק ע." }, img: "https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=150&h=150&fit=crop&crop=faces", status: "online" },
    rami: { name: { ar: "د. رامي خليل", en: "Dr. Rami Khalil", he: "ד״ר ראמי ח." }, img: "https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=150&h=150&fit=crop&crop=faces", status: "busy" },
    mahmoud: { name: { ar: "د. محمود صبري", en: "Dr. Mahmoud S.", he: "ד״ר מחמוד ס." }, img: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=150&h=150&fit=crop&crop=faces", status: "online" },
    sara: { name: { ar: "د. سارة محمد", en: "Dr. Sara M.", he: "ד״ר סארה מ." }, img: "https://images.unsplash.com/photo-1594824813576-96b1f24d4023?w=150&h=150&fit=crop&crop=faces", status: "online" }
  };

  const seedReviews = [
    { 
      name: { ar: "عيسى محمد", en: "Issa M." }, 
      text: { ar: "هل يتعارض المنتج مع أدوية الضغط؟ أنا استخدم حبوب ضغط يومياً وخايف يسبب لي مضاعفات." }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "راشد سالم", en: "Rashid S." }, text: { ar: "سؤال ممتاز، كنت أبحث عن إجابة لهذه النقطة بالتحديد." }, isDoc: false },
        { name: { ar: "فيصل ناصر", en: "Faisal N." }, text: { ar: "أدوية الضغط حساسة، أتمنى التوضيح الطبي الدقيق." }, isDoc: false },
        { name: { ar: "سامي العتيبي", en: "Sami A." }, text: { ar: "الجانب الصحي والأمان هو الأهم قبل الشراء." }, isDoc: false },
        ...
        { ...docs.rami, text: { ar: "نؤكد كلام الزميل د. طارق. لعدم وجود امتصاص جهازي واسع، فهو الخيار الأكثر أماناً." } }
      ] 
    },
    { 
      name: { ar: "أبو سيف", en: "Abu Saif" }, 
      text: { ar: "عندي سكري من النوع الثاني وضعف شديد بالانتصاب.. هل ينفع معي؟" }, 
      stars: 4, 
      replies: [ 
        { name: { ar: "مهند العلي", en: "Muhannad A." }, text: { ar: "نفس حالتي تقريباً، هل النتيجة تظهر بسرعة مع السكر؟" }, isDoc: false },
        { name: { ar: "جمال الدوسري", en: "Jamal D." }, text: { ar: "السكري يؤثر على التروية، نرجو إفادة الأطباء." }, isDoc: false },
        { ...docs.sara, text: { ar: "مرحباً أبو سيف والأخوة الكرام. نعم فعال جداً. مرضى السكري يعانون من ضعف التروية الدموية الطرفية، ورايز يعمل موضعياً لتنشيط التدفق الدموي فوراً." } },
        { ...docs.mahmoud, text: { ar: "بالتأكيد، أنصحك بالالتزام بالتدليك الجيد لمدة دقيقة لتحقيق أقصى استجابة علاجية." } }
      ] 
    },
    { 
      name: { ar: "خالد عبدالرحمن", en: "Khaled A." }, 
      text: { ar: "نتيجة خرافية من أول استخدام، انصح فيه وبشدة! فعلاً غير حياتي للأفضل." }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "بدر الحربي", en: "Bader H." }, text: { ar: "هل التجربة استمرت معك لفترة طويلة؟" }, isDoc: false },
        { name: { ar: "سلطان العمري", en: "Sultan O." }, text: { ar: "هذا ما نأمله، تجربة موفقة." }, isDoc: false },
        { ...docs.tariq, text: { ar: "نحمد الله أن النتيجة نالت رضاكم، ونؤكد استقرار الفعالية مع الاستخدام المنتظم." } }
      ] 
    },
    { 
      name: { ar: "سالم الشمري", en: "Salem S." }, 
      text: { ar: "سمعت إنه يخدر المنطقة تماماً لدرجة إنك ما تحس بشيء.. هل هذا صحيح؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "عمر الحربي", en: "Omar H." }, text: { ar: "هذا الهاجس الوحيد الذي يمنعني من تجربة البخاخات العادية." }, isDoc: false },
        { name: { ar: "يزيد القحطاني", en: "Yazeed Q." }, text: { ar: "التخدير الكامل يفقد المتعة، نرجو التأكيد." }, isDoc: false },
    ...
    { 
      name: { ar: "يوسف خليل", en: "Yوسف K." }, 
      text: { ar: "كم يدوم المفعول بالضبط؟ وهل لازم اغسله قبل اللقاء؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "ماجد المطيري", en: "Majed M." }, text: { ar: "سؤال مهم جداً لترتيب الوقت." }, isDoc: false },
        { name: { ar: "حسام الجهني", en: "Hussam J." }, text: { ar: "بانتظار رد الفريق الطبي." }, isDoc: false },
        { ...docs.sara, text: { ar: "المفعول الفعلي يبدأ خلال 15 دقيقة ويمتد لساعات. ولا داعي لغسله أبداً لأن الجلد يمتصه بالكامل دون ترك أي أثر." } },
        { ...docs.rami, text: { ar: "الامتصاص التام يمنع أي أثر غير مرغوب." } }
      ] 
    },
    { 
      name: { ar: "سالم المري", en: "Salem M." }, 
      text: { ar: "التوصيل كان سريع جداً والمنتج فعاليته ممتازة وبدون أي تخدير، شكراً لكم من القلب." }, 
      stars: 5, 
      replies: [
        { name: { ar: "طارق السبيعي", en: "Tariq S." }, text: { ar: "كم استغرق الشحن لمسقط؟" }, isDoc: false },
        { name: { ar: "نايف الشمري", en: "Nayef S." }, text: { ar: "تجربة مشجعة جداً." }, isDoc: false }
      ] 
    },
    { 
      name: { ar: "فهد العتيبي", en: "Fahad A." }, 
      text: { ar: "هل استخدامه باستمرار يسبب تعود؟ يعني هل ممكن بعدين ما اقدر بدونه؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "مشعل الرشيدي", en: "Mishaal R." }, text: { ar: "الاعتياد العضوي هو الهاجس الأكبر." }, isDoc: false },
        { name: { ar: "فرحان الشمري", en: "Farhan S." }, text: { ar: "نتمنى إجابة واضحة علمياً." }, isDoc: false },
        { ...docs.rami, text: { ar: "التركيبة آمنة للاستخدام المتكرر ولا تسبب أي إدمان عضوي أو تعود وظائفي نهائياً." } },
        { ...docs.sara, text: { ar: "يمكنك استخدامه وايقافه بحرية تامة دون أي تأثير على الوظائف الطبيعية." } }
      ] 
    },
    { 
      name: { ar: "عبدالإله", en: "Abdulelah" }, 
      text: { ar: "عمري 62 سنة، هل سيفيدني أم أنه مخصص للشباب فقط؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "سعيد القحطاني", en: "Saeed Q." }, text: { ar: "سؤال يهم شريحة كبيرة من المتقدمين بالعمر." }, isDoc: false },
        { ...docs.tariq, text: { ar: "المنتج فعال جداً ومناسب للأعمار المتقدمة. شريحة واسعة من عملائنا فوق الستين ويحققون نتائج ممتازة في استعادة الحيوية." } }
      ] 
    },
    { 
      name: { ar: "ياسر عبدالله", en: "Yasser A." }, 
      text: { ar: "افضل منتج جربته حتى الآن، يعطيك ثقة كبيرة جداً والنتيجة تدوم لفترة طويلة." }, 
      stars: 5, 
      replies: [
        { name: { ar: "وايل العنزي", en: "Wael A." }, text: { ar: "شكراً لك على الإفادة ومصداقية التجربة." }, isDoc: false }
      ] 
    },
    { 
      name: { ar: "تركي", en: "Turki" }, 
      text: { ar: "أنا استخدمت كريمات ثانية وسببت لي صداع واحمرار بالوجه.. هل هذا نفس الشيء؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "سعود الدوسري", en: "Saud D." }, text: { ar: "الصداع هو المشكلة الكبرى في الحبوب والمنتجات الرديئة." }, isDoc: false },
        { ...docs.mahmoud, text: { ar: "لا أبداً. الصداع والاحمرار يحدث بسبب الحبوب الفموية، أما رايز فعلاج موضعي خارجي نقي وآمن تماماً بعيداً عن مجرى الدم العام." } }
      ] 
    },
    { 
      name: { ar: "عمر الفاروق", en: "Omar F." }, 
      text: { ar: "كنت متردد في البداية لكن بعد التجربة تأكدت انه منتج أصلي وقوي ويستحق كل ريال." }, 
      stars: 5, 
      replies: [] 
    },
    { 
      name: { ar: "عادل", en: "Adel" }, 
      text: { ar: "هل ريحته قوية؟ لأنني أنزعج من الروائح الطبية الكيميائية." }, 
      stars: 4, 
      replies: [ 
        { name: { ar: "زياد الشمري", en: "Ziyad S." }, text: { ar: "نقطة الرائحة محورية جداً للاستخدام الهادئ." }, isDoc: false },
        { ...docs.rami, text: { ar: "التركيبة خالية تماماً من العطور النفاذة ومصممة بعناية لكي تتبخر وتختفي رائحتها فور الامتصاص الجلدي." } }
      ] 
    },
    { 
      name: { ar: "محمد الزهراني", en: "Mohammed Z." }, 
      text: { ar: "إذا طلبته، كيف تضمنون لي السرية؟ المندوب هل يعلم محتوى الشحنة؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "نايف العتيبي", en: "Nayef A." }, text: { ar: "السرية تهمنا أكثر من أي شيء آخر." }, isDoc: false },
        { ...docs.tariq, text: { ar: "نلتزم بسرية تامة مطلقة. الشحنة تغلف بكيس أسود مبهم تماماً ولا يكتب عليها اسم المنتج، والمندوب نفسه لا يعلم المحتوى." } }
      ] 
    },
    { 
      name: { ar: "أبو فهد", en: "Abu Fahd" }, 
      text: { ar: "يستحق كل قرش، صلابة غير طبيعية ووقت أطول بكثير." }, 
      stars: 5, 
      replies: [] 
    },
    { 
      name: { ar: "صالح", en: "Saleh" }, 
      text: { ar: "هل يحتاج وصفة طبية لشرائه؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "بندر القحطاني", en: "Bandar Q." }, text: { ar: "هل يتطلب موافقة طبية مسبقة؟" }, isDoc: false },
        { ...docs.sara, text: { ar: "لا، المنتج مصنف كمستحضر عناية طبية شخصية ولا يتطلب أي وصفة طبية." } }
      ] 
    },
    { 
      name: { ar: "وليد", en: "Waleed" }, 
      text: { ar: "أعاني من سرعة شديدة جداً (أقل من دقيقة)، هل سيعالج هذه المشكلة؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "عبدالرحمن الوهبي", en: "Abdulrahman W." }, text: { ar: "نفس المعاناة، نرجو تفصيل دور المنتج في ذلك." }, isDoc: false },
        { ...docs.tariq, text: { ar: "هذه الحالة بالتحديد تستهدفها التركيبة المتقدمة لتعطيك تحكماً مضاعفاً ينهي المشكلة تماماً." } },
        { ...docs.rami, text: { ar: "ستلاحظ الفارق الإيجابي الكبير من الاستخدام الأول." } }
      ] 
    },
    { 
      name: { ar: "محمود خليل", en: "Mahmoud K." }, 
      text: { ar: "المفعول يبدأ بسرعة، تقريبا 15 دقيقة وتكون جاهز تماماً. خدمة العملاء راقية جداً." }, 
      stars: 5, 
      replies: [] 
    },
    { 
      name: { ar: "بدر", en: "Bader" }, 
      text: { ar: "الكمية في العبوة كم تكفي تقريباً؟ السعر شوي مرتفع." }, 
      stars: 4, 
      replies: [ 
        { name: { ar: "فهد السبيعي", en: "Fahad S." }, text: { ar: "الجانب الاقتصادي مهم مع التكرار." }, isDoc: false },
        { ...docs.rami, text: { ar: "نظراً لتركيزه العالي فأنت تحتاج لكمية بسيطة بحجم حبة البازلاء فقط، لذا تكفي العبوة حتى 30 استخداماً كاملاً." } }
      ] 
    },
    { 
      name: { ar: "أحمد الدوسري", en: "Ahmed D." }, 
      text: { ar: "هل يسبب أي حرارة أو لسعة على الجلد وقت الاستخدام؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "صالح المري", en: "Saleh M." }, text: { ar: "التهيج الجلدي عائق كبير." }, isDoc: false },
        { ...docs.mahmoud, text: { ar: "لا يوجد أي لسع أو تهيج، المكونات مختبرة طبياً لتكون لطيفة جداً على الأنسجة الحساسة." } }
      ] 
    },
    { 
      name: { ar: "عبدالله العتيبي", en: "Abdullah A." }, 
    ...
    { 
      ...
      text: { ar: "هل الضمان الذهبي حقيقي فعلاً؟ لو ما نفعني ترجعون فلوسي؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "سالم القحطاني", en: "Salem Q." }, text: { ar: "هل تعويض المال يتم فعلاً بدون مماطلة؟" }, isDoc: false },
        { ...docs.tariq, text: { ar: "نعم حقيقي 100%. إذا لم تلاحظ النتيجة المرجوة خلال 15 دقيقة، استرد أموالك فوراً وبكل سهولة." } }
      ] 
    },
    { 
      name: { ar: "زياد", en: "Ziad" }, 
      text: { ar: "هل يؤثر على الطرف الآخر (الزوجة)؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "ناصر الشهراني", en: "Nasser S." }, text: { ar: "هذا السؤال الأهم لكل متزوج." }, isDoc: false },
        { ...docs.sara, text: { ar: "مطلقاً، شريطة الالتزام بفترة الانتظار (15 دقيقة) حتى يتم الامتصاص الجلدي التام، فلن ينتقل أي أثر." } }
      ] 
    },
    { 
      name: { ar: "سعد الشهراني", en: "Saad S." }, 
    ...
    { 
      name: { ar: "سعد", en: "Saad" }, 
      text: { ar: "متى أحط المنتج بالضبط؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "خالد الحربي", en: "Khaled H." }, text: { ar: "توقيت الاستخدام يفرق في النتيجة كثيراً." }, isDoc: false },
        { ...docs.mahmoud, text: { ar: "قبل اللقاء بـ 15 إلى 20 دقيقة على بشرة نظيفة وجافة تماماً." } }
      ] 
    },
    { 
    ...
    { 
      name: { ar: "عبدالله", en: "Abdullah" }, 
      text: { ar: "هل أقدر استخدمه مع الفياجرا؟" }, 
      stars: 4, 
      replies: [ 
        { name: { ar: "راشد الدوسري", en: "Rashid D." }, text: { ar: "هل الدمج بينهم آمن؟" }, isDoc: false },
        { ...docs.tariq, text: { ar: "لن تحتاج للفياجرا أصلاً، رايز يمنحك الصلابة والتحكم معاً بشكل طبيعي وآمن تماماً." } }
      ] 
    },
    { 
      name: { ar: "ناصر", en: "Nasser" }, 
      text: { ar: "كم يوم ويوصلني الطلب؟ أنا بالرياض." }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "فيصل الحربي", en: "Faisal H." }, text: { ar: "مدة الشحن سريعة لمدن المملكة." }, isDoc: false },
        { ...docs.rami, text: { ar: "التوصيل لمدن المملكة يستغرق من 24 إلى 48 ساعة فقط عبر شركة الشحن السري." } }
      ] 
    },
    { 
      name: { ar: "نواف الدوسري", en: "Nawaf D." }, 
      text: { ar: "كنت خايف أدفع أونلاين بس لما شفت الدفع عند الاستلام ارتحت وطلبت، والمنتج جبار." }, 
      stars: 5, 
      replies: [] 
    },
    { 
      name: { ar: "مروان", en: "Marwan" }, 
      text: { ar: "كيف أدفع لكم؟ وهل الموقع آمن؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "بدر العتيبي", en: "Bader A." }, text: { ar: "الدفع عند الاستلام يريح العميل كثيراً." }, isDoc: false },
        { ...docs.tariq, text: { ar: "الدفع حصرياً عند الاستلام، لا تدفع درهماً واحداً حتى تستلم شحنتك بيدك." } }
      ] 
    },
    { 
      name: { ar: "خالد", en: "Khaled" }, 
      text: { ar: "هل المنتج مسجل ومرخص؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "سلطان الشمري", en: "Sultan S." }, text: { ar: "التراخيص الطبية تزيد الثقة." }, isDoc: false },
        { ...docs.sara, text: { ar: "نعم، المنتج مرخص ومطابق لمعايير الجودة والسلامة الصحية المعتمدة رسمياً." } }
      ] 
    }
  ];
