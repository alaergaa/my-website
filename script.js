(() => {
  ...
  const dict = {
    ...
    clinicSub: { ar: "صرح طبي رائد.. وجهتك الآمنة لاستعادة صحتك وثقتك", en: "A leading medical institution.. Your safe destination", he: "מוסד רפואי מוביל.. היעד הבטח שלך" },
    ...
    ofPhoneLabel: { ar: "رقم الهاتف/واتساب", en: "Phone / WhatsApp", he: "טלפון / וואטسאפ" },
    ...
    phPhone: { ar: "رقم الهاتف/واتساب", en: "Phone / WhatsApp", he: "טלפון / וואטسאפ" },
    ...
    refundFormHint: { ar: "املأ البيانات التالية وسنتواصل معك خلال 24 ساعة.", en: "Fill in the details and we’ll contact you within 24 hours.", he: "מלאו את הפרטים وניצור קשר בתוך 24 שעות." },
    rfName: { ar: "الاسم الكامل", en: "Full name", he: "שם מלא" },
    rfPhone: { ar: "رقم الهاتف/واتساب", en: "Phone / WhatsApp", he: "טלפון / וואטسאפ" },
    ...
    timelineTitle: { ar: "خطوات الشحن السري والمريح 📦", en: "Fast and Discreet Shipping Steps 📦", he: "שלבי משלוח מהיר وדיسקרטי 📦" },
    ...
    mapPinBadge: { ar: "📍 مركز الارتقاء الطبي (مسقط - سلطنة عمان)", en: "📍 Medical Elevation Center (Muscat - Oman)", he: "📍 מרכז העלייה הרפואי (מוסקט - עומאן)" },
    popupGuarTitle: { ar: "تذكير بالضمان الذهبي", en: "Golden Guarantee Reminder", he: "תזכורת אחריות זהב" },
    popupGuarDesc: { ar: "طلبك اليوم محمي بضمان الاسترداد الفوري. النتيجة خلال 15 دقيقة أو استرد أموالك بدون أسئلة. (اضغط للتفاصيل)", en: "Your order is protected by instant money-back guarantee. Result in 15 minutes or money back. (Click for details)", he: "ההזמנה שלך מוגנת באחריות החזר כספי מיידי. תוצאה תוך 15 דקות או כסף בחזרה. (לחץ לפרטים)" }
  };

  const docs = {
    tariq: { name: { ar: "د. طارق عبدالرحمن", en: "Dr. Tariq A.", he: "ד״ר טארק ע." }, img: "assets/slider/طارق.jpeg", status: "online" },
    rami: { name: { ar: "د. رامي خليل", en: "Dr. Rami Khalil", he: "ד״ר ראמי ח." }, img: "assets/slider/رامي.jpeg", status: "busy" },
    mahmoud: { name: { ar: "د. محمود صبري", en: "Dr. Mahmoud S.", he: "ד״ר מחמוד ס." }, img: "assets/slider/محمود.jpeg", status: "online" },
    sara: { name: { ar: "د. سارة محمد", en: "Dr. Sara M.", he: "ד״ר סארה מ." }, img: "assets/slider/سارة.jpeg", status: "online" }
  };
  ...
  const seedReviews = [
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "راشد سالم", en: "Rashid S." }, text: { ar: "فعلاً سؤال مهم جداً، كنت أبحث عن إجابة لنفس النقطة." } },
        ...
        { name: { ar: "سالم المري", en: "Salem M." }, text: { ar: "الله يعطيك العافية دكتور، كلامك ريحني كثير لأني كنت متردد." } }
      ] 
    },
    { 
      ...
      stars: 4, 
      replies: [ 
        { name: { ar: "مهند العلي", en: "Muhannad A." }, text: { ar: "المنتج جداً ممتاز وتجربتي معه شخصياً كانت ممتازة." } },
        ...
        { name: { ar: "سلطان العمري", en: "Sultan O." }, text: { ar: "شكراً دكتورة على التوضيح الدقيق، طلبت عبوتين وبانتظار وصولها." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "بدر الحربي", en: "Bader H." }, text: { ar: "أتفق معك تماماً، النتيجة تظهر من أول مرة بشكل مذهل." } },
        { ...docs.tariq, text: { ar: "نحمد الله أن النتيجة نالت رضاكم، وهذا هو الأثر الطبي المدروس تماماً لتركيبتنا." } },
        { name: { ar: "فيصل ناصر", en: "Faisal N." }, text: { ar: "كلامكم شجعني أطلبه اليوم، شكراً لكل الفريق." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "عمر الحربي", en: "Omar H." }, text: { ar: "اطمئن، الإحساس طبيعي 100% ولا يوجد أي تخدير مزعج." } },
        ...
        { name: { ar: "تركي", en: "Turki" }, text: { ar: "فعلاً الإحساس طبيعي جداً وهذا أسعدني بعد التجربة." } }
      ] 
    },
    { 
      name: { ar: "يوسف خليل", en: "Yousef K." }, 
      text: { ar: "كم يدوم المفعول بالضبط؟ وهل لازم اغسله قبل اللقاء؟" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "ماجد المطيري", en: "Majed M." }, text: { ar: "المفعول يستمر لساعات طويلة والامتصاص كامل." } },
        { ...docs.rami, text: { ar: "المفعول الفعلي يبدأ خلال 15 دقيقة ويمتد لساعات. ولا داعي لغسله أبداً لأن الجلد يمتصه بالكامل." } },
        { name: { ar: "عبدالله", en: "Abdullah" }, text: { ar: "توضيح ممتاز ودقيق، شكراً لسرعة الرد." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [
        { name: { ar: "طارق السبيعي", en: "Tariq S." }, text: { ar: "التوصيل سريع والخصوصية عندهم ممتازة جداً." } },
        { name: { ar: "ناصر", en: "Nasser" }, text: { ar: "كم استغرق الشحن بالضبط يا اخوان؟" } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "مشعل الرشيدي", en: "Mishaal R." }, text: { ar: "استخدمته لفترات ولم ألاحظ أي تعود نهائياً." } },
    ...
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "سعيد القحطاني", en: "Saeed Q." }, text: { ar: "أنصحك به وبقوة، النتائج ممتازة لكافة الأعمار." } },
    ...
    { 
      ...
      stars: 5, 
      replies: [
        { name: { ar: "وايل العنزي", en: "Wael A." }, text: { ar: "تجربة ناجحة بكل المقاييس." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "سعود الدوسري", en: "Saud D." }, text: { ar: "لا يوجد أي صداع أو أعراض جانبية نهائياً مع هذا المنتج." } },
    ...
    { 
      ...
      stars: 5, 
      replies: [
        { name: { ar: "فيصل ناصر", en: "Faisal N." }, text: { ar: "صدقت، يستحق كل ريال تم دفعه فيه." } }
      ] 
    },
    { 
      ...
      stars: 4, 
      replies: [ 
        { name: { ar: "زياد الشمري", en: "Ziyad S." }, text: { ar: "الرائحة خفيفة جداً وتتبخر بسرعة ولا تترك أثراً." } },
        { ...docs.rami, text: { ar: "التركيبة خالية تماماً من العطور النفاذة ومصممة بعناية لكي تتبخر وتختفي رائحتها فور الامتصاص." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "نايف العتيبي", en: "Nayef A." }, text: { ar: "التغليف أسود مبهم تماماً ولا يمكن لأحد معرفة المحتوى." } },
        { ...docs.tariq, text: { ar: "نلتزم بسرية تامة مطلقة. الشحنة تغلف بكيس أسود مبهم والمندوب لا يعلم المحتوى." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [
        { name: { ar: "جمال الدوسري", en: "Jamal D." }, text: { ar: "نتيجة رائعة وتستحق التجربة فعلاً." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "بندر القحطاني", en: "Bandar Q." }, text: { ar: "لا يحتاج وصفة، الطلب سهل ومباشر." } },
    ...
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "عبدالرحمن الوهبي", en: "Abdulrahman W." }, text: { ar: "نعم ستحصل على سيطرة كاملة ووقت مثالي من أول استخدام." } },
        { ...docs.tariq, text: { ar: "هذه الحالة بالتحديد تستهدفها التركيبة المتقدمة لتعطيك تحكماً مضاعفاً." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [
        { name: { ar: "سلطان العمري", en: "Sultan O." }, text: { ar: "خدمة العملاء ممتازة والتوصيل سريع." } }
      ] 
    },
    { 
      ...
      stars: 4, 
      replies: [ 
        { name: { ar: "فهد السبيعي", en: "Fahad S." }, text: { ar: "العبوة مركزة جداً وتكفي لفترة طويلة تتجاوز 30 استخداماً." } },
        { ...docs.rami, text: { ar: "نظراً لتركيزه العالي فأنت تحتاج لكمية بسيطة بحجم حبة البازلاء فقط، لذا تكفي العبوة حتى 30 استخداماً." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "صالح المري", en: "Saleh M." }, text: { ar: "لا يوجد أي لسع أو تهيج، الملمس طبيعي ولطيف جداً." } },
        { ...docs.mahmoud, text: { ar: "لا يوجد أي لسع أو تهيج، المكونات مختبرة طبياً لتكون لطيفة جداً على الأنسجة." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [
        { name: { ar: "سعد الشهراني", en: "Saad S." }, text: { ar: "هذا ما يميزهم، الخصوصية عندهم تامة." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "سالم القحطاني", en: "Salem Q." }, text: { ar: "نعم الضمان حقيقي والخدمة ممتازة." } },
        { ...docs.tariq, text: { ar: "نعم حقيقي 100%. إذا لم تلاحظ النتيجة المرجوة خلال 15 دقيقة، استرد أموالك بكل سهولة." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "ناصر الشهراني", en: "Nasser S." }, text: { ar: "لا يؤثر أبداً بعد فترة الامتصاص المحددة." } },
        { ...docs.sara, text: { ar: "مطلقاً، شريطة الالتزام بفترة الانتظار (15 دقيقة) حتى يتم الامتصاص الجلدي التام." } }
      ] 
    },
    { 
      ...
      stars: 4, 
      replies: [
        { name: { ar: "خالد الحربي", en: "Khaled H." }, text: { ar: "تتغاضى عن التأخير البسيط أمام جودة النتيجة." } }
      ] 
    },
    { 
      name: { ar: "سعد", en: "Saad" }, 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "يزيد القحطاني", en: "Yazeed Q." }, text: { ar: "قبل اللقاء بربع ساعة على بشرة نظيفة." } },
    ...
    { 
      ...
      stars: 5, 
      replies: [
        { name: { ar: "فرحان الشمري", en: "Farhan S." }, text: { ar: "تجربة موفقة وتستحق الاعتماد." } }
      ] 
    },
    { 
      ...
      stars: 4, 
      replies: [ 
        { name: { ar: "راشد الدوسري", en: "Rashid D." }, text: { ar: "لن تحتاج للحبوب مع هذا المنتج القوي." } },
        { ...docs.tariq, text: { ar: "لن تحتاج للفياجرا أصلاً، رايز يمنحك الصلابة والتحكم معاً بشكل طبيعي وآمن." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "فيصل الحربي", en: "Faisal H." }, text: { ar: "يوصل خلال يوم أو يومين بحد أقصى." } },
        { ...docs.rami, text: { ar: "التوصيل لمدن المملكة يستغرق من 24 إلى 48 ساعة فقط عبر شركة الشحن." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [
        { name: { ar: "بدر العتيبي", en: "Bader A." }, text: { ar: "الدفع عند الاستلام ميزة أمان كبرى." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "سلطان الشمري", en: "Sultan S." }, text: { ar: "الموقع موثوق والدفع عند الاستلام." } },
        { ...docs.tariq, text: { ar: "الدفع حصرياً عند الاستلام، لا تدفع شيئاً حتى تستلم شحنتك بيدك." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "صالح المري", en: "Saleh M." }, text: { ar: "نعم مرخص ومطابق لمعايير الجودة." } },
        { ...docs.sara, text: { ar: "نعم، المنتج مرخص ومطابق لمعايير الجودة والسلامة الصحية المعتمدة." } }
      ] 
    }
  ];
  ...
  // --- Personal Slider Animation (personal1 <-> personal2) ---
  function startPersonalSlider() {
    const img1 = document.getElementById("personalSlide1");
    const img2 = document.getElementById("personalSlide2");
    if(!img1 || !img2) return;
    setInterval(() => {
  ...
  setTimeout(startPersonalSlider, 500);
