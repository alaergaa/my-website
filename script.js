(() => {
  ...
  const dict = {
    ...
    countryPS: { ar: "الضفة", en: "West Bank", he: "הגדה המערבית" },
    ...
    stickyBuyBtn: { ar: "اطلب الآن والدفع عند الاستلام", en: "Order Now - Cash on Delivery", he: "הזמן עכשיו - תשלום במשלוח" }
  };
  ...
  const seedReviews = [
    { 
      ...
      replies: [
        ...
        { name: { ar: "محمد", en: "Mohammed", he: "מוחמד" }, text: { ar: "ما شاء الله، جاري الطلب.", en: "Wow, ordering now.", he: "וואו, מזמין עכשיו." } }
      ]
    },
    { 
      ...
      replies: [
        ...
        { name: { ar: "يوسف", en: "Youssef", he: "יוסף" }, text: { ar: "فعلاً آمن جداً ومريح.", en: "Very safe and comfortable indeed.", he: "באמת מאוד בטוח ונוח." } }
      ]
    },
    { 
      ...
      replies: [
        ...
        { name: { ar: "بدر", en: "Bader", he: "בדר" }, text: { ar: "انا جربته واخذ معي 20 دقيقة بالضبط.", en: "I tried it and took exactly 20 mins.", he: "ניסיתי וזה לקח לי בדיוק 20 דקות." } },
        { name: { ar: "علي", en: "Ali", he: "עלי" }, text: { ar: "ممتاز، يعطيك العافية.", en: "Excellent, thank you.", he: "מצוין, תודה." } }
      ]
    },
    { 
      ...
      replies: [
        ...
        { name: { ar: "فهد", en: "Fahd", he: "פהד" }, text: { ar: "شكرا عمر على التوضيح.", en: "Thanks Omar for clarifying.", he: "תודה עומר על ההבהרה." } }
      ]
    },
    { 
      ...
      replies: [
        ...
        { name: { ar: "جابر", en: "Jaber", he: "ג'אבר" }, text: { ar: "فعلاً ما يترك أثر دهني، وهذا مريح جداً.", en: "It really leaves no greasy trace, very comfortable.", he: "זה באמת לא משאיר עקבות שומניים, נוח מאוד." } }
      ]
    },
    { 
    ...
    { 
      ...
      replies: [
        ...
        { name: { ar: "خالد", en: "Khaled", he: "חאלד" }, text: { ar: "احسن شي عشان الاحراج.", en: "Best thing to avoid embarrassment.", he: "הדבר הטוב ביותר למנוע מבוכה." } }
      ]
    },
    { 
      ...
      replies: [
        ...
        { name: { ar: "سعد الشهراني", en: "Saad S.", he: "סעד ש." }, text: { ar: "صحيح النتيجة اهم شي.", en: "Right, the result is most important.", he: "נכון, התוצאה היא החשובה ביותר." } }
      ]
    },
    { 
    ...
    { 
      ...
      text: { ar: "أعطيه 4 نجوم بسبب الكمية، لكن المفعول يغطي بصراحة.", en: "4 stars because of quantity, but effect covers it.", he: "4 כוכבים בגלל הכמות, אבל ההשפעה מכסה על זה." }, 
      stars: 4,
      replies: [
        { name: { ar: "عمر", en: "Omar", he: "עומר" }, text: { ar: "العبوة تكفيك فترة طويلة لو تحط نقطة بسيطة.", en: "Lasts long if you use a small drop.", he: "מספיק לזמן רב אם משתמשים בטיפה קטנה." } },
        { name: { ar: "ماجد التميمي", en: "Majed T.", he: "מאג'ד ת." }, text: { ar: "صحيح، عشان كذا بطلب عرض العبوتين المرة الجاية.", en: "Right, next time I'll get 2 bottles.", he: "נכון, לכן אזמין 2 בקבוקים בפעם הבאה." } },
        { name: { ar: "نايف", en: "Nayef", he: "נאיף" }, text: { ar: "كم مرة استخدمتها؟", en: "How many times used?", he: "כמה פעמים השתמשת?" } },
        { name: { ar: "ماجد التميمي", en: "Majed T.", he: "מאג'ד ת." }, text: { ar: "8 مرات ولسه فيها.", en: "8 times and still has.", he: "8 פעמים ועדיין יש." } }
      ]
    }
  ];
  ...
  const setLang = (lang) => {
    ...
    if(stickyBtn && dict.stickyBuyBtn) {
       stickyBtn.textContent = dict.stickyBuyBtn[lang] || dict.stickyBuyBtn.ar;
    }
...
(() => {
  ...
  let currentPrices = { "1": 80, "2": 120, "3": 160 };

  const updateTotal = () => {
    if (!qtySelect || !totalPrice) return;
    const v = qtySelect.value || "1";
    totalPrice.textContent = `${currentPrices[v] ?? currentPrices["1"]} ₪`;
  };
