(() => {
  ...
  const dict = {
    ...
    // قسم من نحن العصري
    aboutHtml: {
      ar: `<div class="modern-about">
            <div class="about-item"><div class="about-icon">🎯</div><div class="about-text"><strong>رؤيتنا:</strong> تقديم حلول طبية مبتكرة وآمنة للرجال.</div></div>
            <div class="about-item"><div class="about-icon">🛡️</div><div class="about-text"><strong>جودتنا:</strong> تركيبات معتمدة تعيد لك الثقة بدون آثار جانبية.</div></div>
            <div class="about-item"><div class="about-icon">🔒</div><div class="about-text"><strong>التزامنا:</strong> خصوصية تامة في كل خطوة من الطلب حتى الاستلام.</div></div>
           </div>`,
      en: `<div class="modern-about">
            <div class="about-item"><div class="about-icon">🎯</div><div class="about-text"><strong>Our Vision:</strong> Providing safe, innovative medical solutions.</div></div>
            <div class="about-item"><div class="about-icon">🛡️</div><div class="about-text"><strong>Our Quality:</strong> Certified formulas that restore confidence safely.</div></div>
            <div class="about-item"><div class="about-icon">🔒</div><div class="about-text"><strong>Our Commitment:</strong> Full privacy from ordering to delivery.</div></div>
           </div>`,
      he: `<div class="modern-about">
            <div class="about-item"><div class="about-icon">🎯</div><div class="about-text"><strong>החזון שלנו:</strong> אספקת פתרונות רפואיים בטוחים וחדשניים.</div></div>
            <div class="about-item"><div class="about-icon">🛡️</div><div class="about-text"><strong>האיכות שלנו:</strong> נוסחאות מאושרות שמחזירות את הביטחון בבטחה.</div></div>
            <div class="about-item"><div class="about-icon">🔒</div><div class="about-text"><strong>המחויבות שלנו:</strong> פרטיות מלאה מההזמנה ועד המסירה.</div></div>
           </div>`
    },

    footerInfo: {
      ar: `<div class="fc-welcome">نحن هنا من أجلك، لتقديم رعاية صحية تليق بك وبثقتك.</div>
           <p>📍 <strong>العنوان:</strong> القدس، جبل الزيتون، بجوار فندق الأمل</p>
           <p>🕒 <strong>مواعيد العمل:</strong> 9:00 صباحاً حتي 9:00 مساءً (الجمعة إجازة)</p>`,
      en: `<div class="fc-welcome">We are here for you, providing health care worthy of your trust.</div>
           ...
           <p>🕒 <strong>Hours:</strong> 9:00 AM to 9:00 PM (Closed Friday)</p>`,
      he: `<div class="fc-welcome">אנחנו כאן בשבילך, מספקים שירותי בריאות הראויים לאמון שלך.</div>
           ...
           <p>🕒 <strong>שעות:</strong> 9:00 עד 21:00 (סגור בשישי)</p>`
    },

    goldGuaranteeHtml: {
      ar: `<div class="gold-icon">🏆</div>
           <h4 class="gold-title">ضمان استرداد الأموال 100%</h4>
           <p class="gold-desc">نحن واثقون من منتجنا. إذا لم تحصل على نتيجة مرضية خلال 15 دقيقة من الاستخدام الصحيح، يحق لك استرداد كامل المبلغ فوراً وبدون أي أسئلة معقدة.</p>`,
      en: `<div class="gold-icon">🏆</div><h4 class="gold-title">100% Money Back Guarantee</h4><p class="gold-desc">We are confident in our product. If you don't see satisfactory results within 15 minutes, you can get a full refund instantly.</p>`,
      he: `<div class="gold-icon">🏆</div><h4 class="gold-title">100% החזר כספי מובטח</h4><p class="gold-desc">אנו בטוחים במוצר שלנו. אם לא תראה תוצאות מספקות תוך 15 דקות, תוכל לקבל החזר מלא באופן מיידי.</p>`
    },

    // الأسئلة الشائعة (مفتوحة تلقائياً عن طريق كلاس is-open)
    faqHtml: {
      ar: `<div class='faq-list'>
            ...
            <div class='faq-item is-open'>
              ...
              <div class='faq-a'><p>نعم بكل تأكيد. نظراً لأنه علاج موضعي خارجي، فهو لا يتعارض مع أدوية السكري أو الضغط، ويعتبر البديل الطبي الأكثر أماناً لمرضى القلب.</p></div>
            </div>
            <div class='faq-item is-open'>
              <button class='faq-q'>هل يسبب المنتج أي تخدير أو فقدان للإحساس؟</button>
              <div class='faq-a'><p>إطلاقاً. على عكس البخاخات التقليدية، تركيبتنا الطبية تؤخر القذف وتزيد الصلابة مع الحفاظ على المتعة والإحساس الطبيعي 100% لك وللشريكة.</p></div>
            </div>
            <div class='faq-item is-open'>
            ...
            <div class='faq-item is-open'>
              <button class='faq-q'>ماذا لو لم أستفد من المنتج؟</button>
              <div class='faq-a'><p>نحن في مركز الارتقاء الطبي نثق بمنتجنا. إذا استخدمت المنتج بالطريقة الصحيحة ولم تلاحظ نتيجة من أول تجربة، فنحن نضمن لك استرداد أموالك بالكامل بكل شفافية.</p></div>
            </div>
            <div class='faq-item is-open'>
    ...
    btn.addEventListener("click", (e) => {
      ...
      try{
        ...
        if (typeof window.scrollTo === "function"){
          try{ window.scrollTo({ top: Math.max(0, Math.round(y)), behavior: "smooth" });
          setTimeout(()=>{ try{ const y2 = (el.getBoundingClientRect().top + (window.pageYOffset||0)) - offset - 8; window.scrollTo({ top: Math.max(0, Math.round(y2)), behavior: "auto" }); }catch(_e){} }, 260);
          }catch(_e){ window.scrollTo(0, Math.max(0, Math.round(y))); }
        }
      }catch(_e){}
