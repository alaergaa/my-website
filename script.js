(() => {
  ...
  const dict = {
    ...
    price1: { ar: "79 درهم", en: "79 AED", he: "79 AED" },
    price2: { ar: "109 درهم", en: "109 AED", he: "109 AED" },
  ...
  const qtySelect = document.getElementById("qtySelect"); const totalPrice = document.getElementById("totalPrice"); const prices = { "1": 79, "2": 109 };
  const updateTotal = () => { if (!qtySelect || !totalPrice) return; const v = qtySelect.value || "1"; const curr = (dict.currency && dict.currency[currentLang]) || dict.currency.ar; totalPrice.textContent = `${prices[v] ?? 79} ${curr}`; };
