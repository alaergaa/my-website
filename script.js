(() => {
  ...
  const dict = {
    ...
    successFeature2: { ar: "🚚 شحن سريع وسري", en: "🚚 Fast & Discreet Shipping", he: "🚚 משלוח מהיר وדיסקרטי" },
  ...
  const docs = {
    ...
    mahmoud: { name: { ar: "د. محمود صبري", en: "Dr. Mahmoud S.", he: "ד״ר מחמוד ס." }, img: "https://images.unsplash.com/photo-1612349317150-e410f624c427?w=150&h=150&fit=crop&crop=faces", status: "online" }
  };
  ...
  const seedReviews = [
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.tariq, text: { ar: "أهلاً بك أخي عيسى. لا تقلق أبداً، تركيبة 'رايز' صُممت كعلاج موضعي خارجي لا يدخل في مجرى الدم الكلي، لذلك هي آمنة 100% لمرضى الضغط ولا تتعارض مع أي أدوية تتناولها." } },
    ...
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.tariq, text: { ar: "نحمد الله أن النتيجة نالت رضاكم أخي خالد، وهذا هو الأثر الطبي المطلوب تماماً." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.mahmoud, text: { ar: "هذا اعتقاد خاطئ شائع بسبب البخاخات التجارية القديمة. رايز لا يحتوي على مخدر موضعي بل يعتمد على التنشيط الذكي للتروية دون فقدان الإحساس." } }
      ] 
    },
    { 
