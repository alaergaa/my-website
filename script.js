(() => {
  ...
  const dict = {
    ...
    livePopupMin: { ar: "منذ", en: "Ago", he: "لפני" },
    ...
    bottomOrderBtn: { ar: "اطلب الآن والدفع عند الاستلام", en: "Order Now & Pay on Delivery", he: "הזמן עכשיו ותשלום במשלוח" }
  };
  ...
  // تحديد اللغة التلقائي بناءً على متصفح الزائر
  const browserLang = (navigator.language || navigator.userLanguage || "").substring(0, 2).toLowerCase();
  let initLang = "en"; // الإنجليزية هي الافتراضية لأي لغة غريبة
  if (browserLang === "ar" || browserLang === "he") {
