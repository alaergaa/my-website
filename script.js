(() => {
  ...
  const dict = {
    loaderTitle: { ar: "مركز الارتقاء الطبي", en: "Medical Elevation Center", he: "מרכז העלייה הרפואי" },
    loaderSubtitle: { ar: "رعاية طبية • خصوصية • ثقة", en: "Medical Care • Privacy • Trust", he: "טיפול רפואי • פרטיות • אמון" },
    loaderStatus: { ar: "جاري تجهيز الموقع...", en: "Preparing the website...", he: "מכינים את האתר..." },
    ...
    clinicLocation: { ar: "📍 العنوان: شارع صلاح الدين، مبنى الزهراء، الطابق الرابع، القدس. • 🕒 ساعات العمل: 7:00 صباحاً – 7:00 مساءً • 📅 الجمعة: مغلق", en: "📍 Address: Salah al-Din Street, Al-Zahra Building, 4th Floor, Jerusalem. • 🕒 Working Hours: 7:00 AM – 7:00 PM • 📅 Friday: Closed", he: "📍 כתובת: רחוב צלאח א-דין, בניין א-זהרא, קומה רביעית, ירושלים. • 🕒 שעות פעילות: 07:00–19:00 • 📅 יום שישי: סגור" },
    ...
    scarcityHtml: {
      ar: `<div class="ms-header"><span class="ms-pulse"></span><span class="ms-text">🧪 <strong>دفعة طبية خاصة:</strong> تم صرف <strong>87%</strong> من الحصة المعتمدة للمركز هذا الأسبوع</span></div><div class="ms-bar-container"><div class="ms-bar-fill" style="width:87%"></div></div>`,
      en: `<div class="ms-header"><span class="ms-pulse"></span><span class="ms-text">🧪 <strong>Special Medical Batch:</strong> <strong>87%</strong> of the center's weekly quota dispensed</span></div><div class="ms-bar-container"><div class="ms-bar-fill" style="width:87%"></div></div>`,
      he: `<div class="ms-header"><span class="ms-pulse"></span><span class="ms-text">🧪 <strong>מהדורה רפואית מוגבלת:</strong> <strong>87%</strong> מההקצאה השבועית של המרכז כבר נופקה</span></div><div class="ms-bar-container"><div class="ms-bar-fill" style="width:87%"></div></div>`
    },
    btnCertificate: { ar: "الترخيص الطبي", en: "Certification", he: "אישור רפואי" },
    secCertTitle: { ar: "وثيقة الاعتماد والجودة", en: "Quality & Certification", he: "תעודת איכות" },
    certificateHtml: {
      ar: `<div class="medical-cert-box">
            <div class="cert-watermark"></div>
            <div class="cert-header">
              <h4>📜 وثيقة الاعتماد والجودة الطبية الشاملة لمنتج "رايز" (Rise)</h4>
              <p><strong>صادرة عن:</strong> إدارة الرقابة والجودة - مركز الارتقاء الطبي</p>
            </div>
            <div class="cert-body">
              <p>نلتزم في "مركز الارتقاء الطبي" بتقديم حلول صحية مبنية على أعلى معايير الجودة، الأمان، والفعالية. وبناءً على المراجعات الدقيقة، نُصدر هذا البيان المرجعي لاعتماد منتج "رايز" كخيار آمن وفعال:</p>
              
              <h5 class="cert-section-title">أولاً: التركيبة والسلامة الدوائية</h5>
              <p>يُصنف منتج "رايز" (Rise) كمركب موضعي طبيعي 100%. تم فحص التركيبة بدقة لضمان خلوها التام من المواد الكيميائية الضارة، المنشطات الصناعية، والمواد المخدرة (مثل الليدوكايين والبنذوكايين). وبما أنه مصمم للاستخدام الخارجي فقط، فإنه لا يُمتص في مجرى الدم، مما يمنع حدوث أي تداخلات دوائية أو عبء على وظائف الجسم الحيوية.</p>

              <h5 class="cert-section-title">ثانياً: التوافق مع الأمراض المزمنة (الأمان التام)</h5>
              <p>نظراً لآلية عمله الموضعية البحتة، تم اعتماد المنتج كخيار آمن تماماً للاستخدام من قِبل جميع الفئات العمرية للبالغين، بما في ذلك أصحاب الأمراض المزمنة. نؤكد أن المنتج:</p>
              <ul class="cert-list">
                <li>لا يسبب ارتفاعاً في ضغط الدم.</li>
                <li>لا يؤدي إلى تسارع أو خفقان في نبضات القلب.</li>
                <li>آمن تماماً لمرضى السكري ولا يؤثر على مستويات السكر في الدم.</li>
              </ul>

              <h5 class="cert-section-title">ثالثاً: الفعالية والنتائج السريرية المعتمدة</h5>
              <p>بناءً على تركيبه المتطور، تم اعتماد النتائج التالية للمنتج عند الاستخدام الصحيح:</p>
              <ul class="cert-list">
                <li><strong>استجابة سريعة:</strong> يحفز الدورة الدموية الموضعية ليمنح صلابة قوية ومكتملة خلال 15 دقيقة فقط من الاستخدام.</li>
                <li><strong>السيطرة المضاعفة:</strong> يعمل على تهدئة الاستثارة المفرطة ليمنح المستخدم تأخيراً آمناً يصل إلى <strong>40 دقيقة</strong>، مع الحفاظ على الإحساس الطبيعي الكامل والمتعة دون أي شعور بالتخدير أو البرودة.</li>
              </ul>

              <h5 class="cert-section-title">رابعاً: معايير التعبئة والتغليف</h5>
              <p>يتم إنتاج وتعبئة "رايز" وفقاً لبروتوكولات التعقيم الصارمة، لضمان استقرار التركيبة الطبيعية وحمايتها من أي عوامل خارجية قد تؤثر على جودتها وفعاليتها طوال فترة الصلاحية.</p>
            </div>
            <div class="cert-footer">
              <p><strong>الاعتماد النهائي:</strong> بناءً على ما سبق، نُقر نحن في "مركز الارتقاء الطبي" بأن منتج "رايز" (Rise) مطابق لأعلى مواصفات الجودة والسلامة، ويُعد حلاً آمناً وموثوقاً للقضاء على الضعف وسرعة القذف.</p>
              <div class="cert-stamp">
                <span class="stamp-text">[خـتـم الاعـتـمـاد الـرسـمـي - مـركـز الارتقـاء الـطبـي]</span>
                <span class="stamp-sign">توقيع الإدارة الطبية ــــــــــــــــــــــــــــــــــ</span>
              </div>
            </div>
          </div>`,
      en: `<div class="medical-cert-box">
            <div class="cert-watermark"></div>
            <div class="cert-header">
              <h4>📜 Comprehensive Medical Certification for "Rise"</h4>
              <p><strong>Issued by:</strong> Quality Control Dept. - Medical Elevation Center</p>
            </div>
            <div class="cert-body">
              <p>At Medical Elevation Center, we are committed to providing health solutions based on the highest standards of safety and efficacy. We issue this reference statement certifying "Rise" as a safe and effective choice:</p>
              <h5 class="cert-section-title">1. Formula & Pharmacological Safety</h5>
              <p>Rise is a 100% natural topical compound. It is completely free of harmful chemicals and anesthetics (like Lidocaine). Designed for external use only, it does not enter the bloodstream.</p>
              <h5 class="cert-section-title">2. Compatibility with Chronic Diseases</h5>
              <p>Due to its topical mechanism, the product is completely safe for all adult age groups, including those with chronic diseases:</p>
              <ul class="cert-list">
                <li>Does not cause high blood pressure or rapid heartbeat.</li>
                <li>Completely safe for diabetics and does not affect blood sugar.</li>
              </ul>
              <h5 class="cert-section-title">3. Efficacy & Clinical Results</h5>
              <ul class="cert-list">
                <li><strong>Rapid Response:</strong> Provides strong hardness within just 15 minutes.</li>
                <li><strong>Double Control:</strong> Grants a safe delay of up to <strong>40 minutes</strong>, maintaining full natural pleasure without any numbness.</li>
              </ul>
            </div>
            <div class="cert-footer">
              <p><strong>Final Certification:</strong> We declare that "Rise" complies with the highest quality and safety specifications.</p>
              <div class="cert-stamp">
                <span class="stamp-text">[Official Certification Seal - Medical Elevation Center]</span>
                <span class="stamp-sign">Medical Management Signature ــــــــــــــــــــــــ</span>
              </div>
            </div>
          </div>`,
      he: `<div class="medical-cert-box">
            <div class="cert-watermark"></div>
            <div class="cert-header">
              <h4>📜 מסמך אישור רפואי ואיכות מקיף עבור "רייז"</h4>
              <p><strong>הונפק על ידי:</strong> מחלקת בקרת איכות - מרכז העלייה הרפואי</p>
            </div>
            <div class="cert-body">
              <p>אנו מתחייבים לספק פתרונות בריאות המבוססים על הסטנדרטים הגבוהים ביותר של בטיחות ויעילות. אנו מנפיקים הצהרה זו המאשרת את "רייז" כבחירה בטוחה ויעילה:</p>
              <h5 class="cert-section-title">1. נוסחה ובטיחות רפואית</h5>
              <p>רייז הוא תרכובת מקומית טבעית ב-100%. נקי לחלוטין מכימיקלים וחומרי הרדמה. לשימוש חיצוני בלבד, אינו חודר למחזור הדם.</p>
              <h5 class="cert-section-title">2. בטיחות למחלות כרוניות</h5>
              <ul class="cert-list">
                <li>אינו גורם ללחץ דם גבוה או דופק מהיר.</li>
                <li>בטוח לחלוטין לחולי סוכרת.</li>
              </ul>
              <h5 class="cert-section-title">3. יעילות קלינית</h5>
              <ul class="cert-list">
                <li><strong>תגובה מהירה:</strong> מספק זקפה חזקה תוך 15 דקות בלבד.</li>
                <li><strong>שליטה כפולה:</strong> מעניק עיכוב בטוח של עד <strong>40 דקות</strong>, תוך שמירה על הנאה טבעית מלאה ללא חוסר תחושה.</li>
              </ul>
            </div>
            <div class="cert-footer">
              <p><strong>אישור סופי:</strong> אנו מצהירים כי "רייז" עומד במפרטי האיכות והבטיחות הגבוהים ביותר.</p>
              <div class="cert-stamp">
                <span class="stamp-text">[חותמת אישור רשמית - מרכז העלייה הרפואי]</span>
                <span class="stamp-sign">חתימת הנהלה רפואית ــــــــــــــــــــــــ</span>
              </div>
            </div>
          </div>`
    },
    ...
    goldGuaranteeHtml: {
      ar: `<div class="gold-icon">🏆</div>
           ...
           <ul class="bulletList" style="text-align:right; font-size:13.5px; color:#78350f; background:rgba(255,255,255,0.4); padding:12px 24px; border-radius:12px;">
             <li>⏱️ <strong>اختبار الـ 15 دقيقة:</strong> إذا لم تحصل على قوة وتأخير ملحوظ خلال 15 دقيقة، لك الحق في استرداد كل شيكل.</li>
    ...
    aboutHtml: {
      ar: `<div class="sectionRich">
            <p class="richIntro">نحن في <strong>"مركز الارتقاء الطبي"</strong> لسنا مجرد نقطة بيع، بل صرح طبي رائد وموثوق في القدس. كرسنا جهودنا لتقديم حلول صحية مبتكرة تركز حصرياً على "صحة الرجل"، وتوفير علاجات جذرية وآمنة لمشاكل الضعف والارتخاء.</p>
      ...
      en: `<div class="sectionRich">
            <p class="richIntro">At <strong>Medical Elevation Center</strong>, we are a leading and trusted medical institution in Jerusalem dedicated exclusively to men's health.</p>
            <div class="modern-about">
      ...
      he: `<div class="sectionRich">
            <p class="richIntro">ב-<strong>מרכז העלייה הרפואי</strong>, אנו מוסד רפואי מוביל ואמין בירושלים, המוקדש בלעדית לבריאות הגבר.</p>
            <div class="modern-about">
    ...
    footerInfo: {
      ar: `<div class="fc-welcome">نحن هنا من أجلك، لتقديم رعاية صحية تليق بك وبثقتك.</div><p>📍 <strong>العنوان:</strong> شارع صلاح الدين، مبنى الزهراء، الطابق الرابع، القدس.</p><p>📞 <strong>للتواصل والواتساب:</strong> <span style="direction:ltr; display:inline-block;">+972512865105</span></p><p>🕒 <strong>ساعات العمل:</strong> 7:00 صباحاً – 7:00 مساءً</p><p>📅 <strong>الجمعة:</strong> مغلق</p>`,
      en: `<div class="fc-welcome">We are here for you, providing health care worthy of your trust.</div><p>📍 <strong>Address:</strong> Salah al-Din Street, Al-Zahra Building, 4th Floor, Jerusalem.</p><p>📞 <strong>WhatsApp:</strong> <span style="direction:ltr; display:inline-block;">+972512865105</span></p><p>🕒 <strong>Working Hours:</strong> 7:00 AM – 7:00 PM</p><p>📅 <strong>Friday:</strong> Closed</p>`,
      he: `<div class="fc-welcome">אנחנו כאן בשבילך, מספקים שירותי בריאות הראויים לאמון שלך.</div><p>📍 <strong>כתובת:</strong> רחוב צלאח א-דין, בניין א-זהרא, קומה רביעית, ירושלים.</p><p>📞 <strong>וואטסאפ:</strong> <span style="direction:ltr; display:inline-block;">+972512865105</span></p><p>🕒 <strong>שעות פעילות:</strong> 07:00–19:00</p><p>📅 <strong>יום שישי:</strong> סגור</p>`
    },
    faqHtml: {
      ar: `<div class='faq-list'>
            <div class='faq-item is-open'><button class='faq-q'>هل يقضي المنتج على الارتخاء التام ويمنحني صلابة قوية حتى لو كان الانتصاب معدوماً؟</button><div class='faq-a'><p>نعم، بكل تأكيد. تركيبة "رايز" مصممة لتنشيط الدورة الدموية الموضعية بشكل مكثف، مما يقضي على ارتخاء القضيب نهائياً ويمنحك استجابة فورية وصلابة صخرية خلال 15 دقيقة فقط، حتى في حالات انعدام الانتصاب.</p></div></div>
            <div class='faq-item is-open'><button class='faq-q'>أنا مريض سكري ولا يوجد لدي انتصاب نهائياً، هل يفيدني المنتج؟</button><div class='faq-a'><p>نعم، المنتج يعتبر الحل الأمثل والآمن لمرضى السكري. السكري يضعف التروية الدموية الطرفية، و"رايز" يعمل موضعياً لتوجيه التدفق الدموي للمنطقة دون الدخول في مجرى الدم، مما يمنحك انتصاباً طبيعياً وقوياً بأمان تام.</p></div></div>
            <div class='faq-item is-open'><button class='faq-q'>هل المفعول فوري أم علاج نهائي؟</button><div class='faq-a'><p>المنتج يمنحك الأمرين معاً؛ فهو يوفر <strong>مفعولاً فورياً</strong> خلال 15 دقيقة للقاء الواحد، وللحصول على <strong>نتيجة نهائية ودائمة</strong> والتخلص من الضعف تماماً، يُنصح باستخدام "الكورس العلاجي" (عن طريق دهن المنطقة يومياً قبل النوم).</p></div></div>
            <div class='faq-item is-open'><button class='faq-q'>هل بعد استخدام "الكورس العلاجي" لشهرين أرجع طبيعي وأتخلص من الارتخاء وسرعة القذف نهائياً؟</button><div class='faq-a'><p>نعم، هذا هو الهدف من الكورس العلاجي. الاستخدام اليومي المستمر لمدة شهرين (عبوتين) يعمل على إعادة تأهيل وتنشيط الأوعية الدموية. بعد انتهاء الكورس، ستستعيد قدرتك الطبيعية وتتحكم بالوقت بشكل دائم دون الحاجة للاعتماد على أي منتج.</p></div></div>
      ...
      en: `<div class='faq-list'>
            <div class='faq-item is-open'><button class='faq-q'>Does the product completely eliminate ED and give strong hardness even with zero erection?</button><div class='faq-a'><p>Yes, absolutely. Rise's formula intensely stimulates local blood circulation, eliminating penile flaccidity and giving you a rock-solid hardness in just 15 minutes, even in cases of zero erection.</p></div></div>
            <div class='faq-item is-open'><button class='faq-q'>I am diabetic and have zero erection, will it work for me?</button><div class='faq-a'><p>Yes, it is the optimal and safe solution for diabetics. It works topically to direct blood flow without entering the bloodstream, giving you a strong, natural erection safely.</p></div></div>
            <div class='faq-item is-open'><button class='faq-q'>Is the effect instant or a permanent cure?</button><div class='faq-a'><p>The product gives you both. It provides an <strong>instant effect</strong> within 15 minutes, and for a <strong>permanent result</strong>, it is recommended to use the Treatment Course (applied daily before sleep).</p></div></div>
            <div class='faq-item is-open'><button class='faq-q'>Will I get rid of ED permanently after the 2-month course?</button><div class='faq-a'><p>Yes. Continuous daily use for two months rehabilitates blood vessels. After the course, you will regain your natural ability and control permanently without relying on any product.</p></div></div>
      ...
      he: `<div class='faq-list'>
            <div class='faq-item is-open'><button class='faq-q'>האם המוצר מעלים לחלוטין חולשה ומעניק זקפה חזקה גם אם אין זקפה כלל?</button><div class='faq-a'><p>כן, בהחלט. הנוסחה ממריצה את זרימת הדם המקומית ומעניקה לך תגובה מיידית וזקפה חזקה תוך 15 דקות, גם במקרים של היעדר זקפה מוחלט.</p></div></div>
            <div class='faq-item is-open'><button class='faq-q'>אני חולה סוכרת ואין לי זקפה בכלל, האם זה יעזור לי?</button><div class='faq-a'><p>כן, המוצר הוא הפתרון האופטימלי והבטוח ביותר לחולי סוכרת. רייז פועל באופן מקומי להכוונת זרימת הדם לאזור מבלי לחדור למחזור הדם.</p></div></div>
            <div class='faq-item is-open'><button class='faq-q'>האם ההשפעה מיידית או טיפול קבוע?</button><div class='faq-a'><p>המוצר מעניק לך את שניהם. השפעה <strong>מיידית</strong> תוך 15 דקות, ולתוצאה <strong>קבועה</strong> מומלץ להשתמש ב"קורס הטיפולי" (מריחה יומית).</p></div></div>
            <div class='faq-item is-open'><button class='faq-q'>האם לאחר שימוש בקורס הטיפולי אחזור למצב רגיל ואפטר מחולשה לתמיד?</button><div class='faq-a'><p>כן, זו המטרה. שימוש יומיומי רציף לחודשיים משקם את כלי הדם, כך שתחזור לתפקוד טבעי ולשליטה קבועה ללא תלות בשום מוצר.</p></div></div>
    ...
    countryWB: { ar: "الضفة", en: "West Bank", he: "הגדה המערבית" },
    currency: { ar: "شيكل", en: "ILS", he: "₪" },
    price1: { ar: "100 شيكل", en: "100 ILS", he: "100 ₪" },
    price2: { ar: "150 شيكل", en: "150 ILS", he: "150 ₪" },
    price3: { ar: "250 شيكل", en: "250 ILS", he: "250 ₪" },
    ...
    offersTitle: { ar: "عروض اليوم", en: "Today's Offers", he: "מבצעי اليوم" },
    ...
    mapModalTitle: { ar: "📍 موقع مركز الارتقاء الطبي (القدس)", en: "📍 Medical Elevation Center Location (Jerusalem)", he: "📍 מיקום מרכז העלייה הרפואי (ירושלים)" },
    mapPinBadge: { ar: "📍 مركز الارتقاء الطبي — شارع صلاح الدين، مبنى الزهراء، الطابق الرابع، القدس", en: "📍 Medical Elevation Center — Salah al-Din Street, Al-Zahra Building, 4th Floor, Jerusalem", he: "📍 מרכז העלייה הרפואי — רחוב צלאח א-דין, בניין א-זהרא, קומה רביעית, ירושלים" },
  ...
  const docs = {
    ...
    sara: { name: { ar: "د. سارة محمد", en: "Dr. Sara Mohamed", he: "ד״ר שרה מוחמד" }, img: "assets/slider/سارة.jpeg", status: "online" }
  };

  const seedReviews = [
    { 
      name: { ar: "عيسى محمد", en: "Issa Mohamed", he: "עיסא מוחמד" }, 
      text: { ar: "هل يتعارض المنتج مع أدوية الضغط؟ أنا استخدم حبوب ضغط يومياً وخايف يسبب لي مضاعفات.", en: "Does the product conflict with blood pressure medications? I use them daily and am worried.", he: "האם המוצר מתנגש עם תרופות ללחץ דם? אני משתמש בהן מדי יום ודואג." }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "راشد سالم", en: "Rashid Salem", he: "ראשיד סאלם" }, text: { ar: "فعلاً سؤال مهم جداً، كنت أبحث عن إجابة لنفس النقطة.", en: "Very important question, I was looking for the same answer.", he: "שאלה חשובה מאוד, חיפשתי תשובה לאותה נקודה." } },
        { ...docs.tariq, text: { ar: "أهلاً بك أخي الكريم. لا تقلق أبداً، تركيبة 'رايز' صُممت كعلاج موضعي خارجي لا يدخل في مجرى الدم الكلي، لذلك هي آمنة تماماً لمرضى الضغط.", en: "Hello brother. Do not worry, Rise formula is a topical treatment that doesn't enter the bloodstream, totally safe for blood pressure patients.", he: "שלום אחי. אל תדאג, נוסחת רייז היא טיפול מקומי שאינו חודר למחזור הדם, בטוח לחלוטין לחולי לחץ דם." } },
        { name: { ar: "م. س", en: "M. S", he: "מ. ס" }, text: { ar: "الله يعطيك العافية دكتور، كلامك ريحني كثير لأني كنت متردد.", en: "God bless you doctor, your words relieved me.", he: "תודה דוקטור, המילים שלך הרגיעו אותי." } },
        { name: { ar: "أبو سيف", en: "Abu Saif", he: "אבו סייף" }, text: { ar: "عن تجربة يا غالي انا مريض ضغط ولافيه اي تأثير الحمدلله.", en: "From experience, I am a blood pressure patient and no side effects thankfully.", he: "מניסיון, אני חולה לחץ דם ואין תופעות לוואי לשמחתי." } },
        { name: { ar: "VIP_2023", en: "VIP_2023", he: "VIP_2023" }, text: { ar: "يعطيكم العافية منتج يستحق.", en: "Great job, a product worth it.", he: "כל הכבוד, מוצר שווה את זה." } }
      ] 
    },
    { 
      name: { ar: "أبو سيف", en: "Abu Saif", he: "אבו סייף" }, 
      text: { ar: "عندي سكري من النوع الثاني وضعف شديد بالانتصاب.. هل ينفع معي؟", en: "I have type 2 diabetes and severe weakness. Will it work for me?", he: "יש לי סוכרת סוג 2 וחולשה חמורה. האם זה יעבוד עבורי?" }, 
      stars: 4, 
      replies: [ 
        { name: { ar: "مهند العلي", en: "Mohannad Al-Ali", he: "מוהנד אל עלי" }, text: { ar: "المنتج جداً ممتاز وتجربتي معه شخصياً كانت ممتازة.", en: "The product is excellent and my personal experience was great.", he: "המוצר מצוין והניסיון האישי שלי היה נהדר." } },
        { ...docs.sara, text: { ar: "حياك الله. نعم فعال جداً في حالتك. مرضى السكري يعانون من ضعف التروية الدموية الطرفية، ورايز يعمل موضعياً لتنشيط التدفق الدموي فوراً.", en: "Welcome. Yes, very effective in your case. Rise works topically to stimulate blood flow immediately.", he: "ברוך הבא. כן, יעיל מאוד במקרה שלך. רייז פועל באופן מקומי לעידוד זרימת הדם באופן מיידי." } },
        { name: { ar: "سلطان العمري", en: "Sultan Al-Omari", he: "סולטאן אל עומרי" }, text: { ar: "شكراً دكتورة على التوضيح الدقيق، طلبت عبوتين وبانتظار وصولها.", en: "Thanks doctor for the clear explanation, ordered 2 bottles.", he: "תודה דוקטור על ההסבר הברור, הזמנתי 2 בקבוקים." } },
        { name: { ar: "H.A", en: "H.A", he: "H.A" }, text: { ar: "انا عندي سكري وفعلا غير حياتي للأفضل.", en: "I have diabetes and it really changed my life for the better.", he: "יש לי סוכרת וזה באמת שינה את חיי לטובה." } }
      ] 
    },
    { 
      name: { ar: "خالد عبدالرحمن", en: "Khalid Abdulrahman", he: "ח'אלד עבדולרחמן" }, 
      text: { ar: "نتيجة خرافية من أول استخدام، انصح فيه وبشدة! فعلاً غير حياتي للأفضل.", en: "Amazing result from the first use, highly recommended! Truly changed my life.", he: "תוצאה מדהימה מהשימוש הראשון, מומלץ בחום! באמת שינה את חיי." }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "بدر الحربي", en: "Bader Al-Harbi", he: "בדר אל-חרבי" }, text: { ar: "أتفق معك تماماً، النتيجة تظهر من أول مرة بشكل مذهل.", en: "I completely agree, the result shows amazingly from the first time.", he: "אני מסכים לחלוטין, התוצאה מראה באופן מדהים מהפעם הראשונה." } },
        { ...docs.tariq, text: { ar: "نحمد الله أن النتيجة نالت رضاكم، وهذا هو الأثر الطبي المدروس تماماً لتركيبتنا.", en: "Glad you are satisfied, this is the well-studied medical effect of our formula.", he: "שמחים שאתה מרוצה, זוהי ההשפעה הרפואית הנחקרת היטב של הנוסחה שלנו." } },
        { name: { ar: "فيصل ناصر", en: "Faisal Nasser", he: "פייסל נאצר" }, text: { ar: "كلامكم شجعني أطلبه اليوم، شكراً لكل الفريق.", en: "Your words encouraged me to order today, thanks to the team.", he: "המילים שלך עודדו אותי להזמין היום, תודה לצוות." } },
        { name: { ar: "عاشق الصمت", en: "Silent Lover", he: "אוהב שקט" }, text: { ar: "انا استخدمه من شهر تقريبا ولا غلطة.", en: "Been using it for a month, flawless.", he: "משתמש בזה חודש, ללא תקלות." } },
        { name: { ar: "أبو فهد", en: "Abu Fahd", he: "אבו פאהד" }, text: { ar: "متى يوصل اذا طلبت للرياض؟", en: "When will it arrive to Riyadh?", he: "מתי זה יגיע לריאד?" } },
        { name: { ar: "ماجد المطيري", en: "Majed Al-Mutairi", he: "מאג'ד אל-מוטיירי" }, text: { ar: "أبو فهد يوصلك خلال يومين بالكثير.", en: "Abu Fahd, it takes 2 days maximum.", he: "אבו פאהד, זה לוקח יומיים לכל היותר." } }
      ] 
    },
    { 
      name: { ar: "سالم الشمري", en: "Salem Al-Shammari", he: "סאלם אל-שמארי" }, 
      text: { ar: "سمعت إنه يخدر المنطقة تماماً لدرجة إنك ما تحس بشيء.. هل هذا صحيح؟", en: "I heard it numbs the area completely so you feel nothing. Is this true?", he: "שמעתי שזה מרדים את האזור לחלוטין כך שאתה לא מרגיש כלום. האם זה נכון?" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "عمر الحربي", en: "Omar Al-Harbi", he: "עומר אל-חרבי" }, text: { ar: "اطمئن، الإحساس طبيعي 100% ولا يوجد أي تخدير مزعج.", en: "Rest assured, sensation is 100% natural, no annoying numbness.", he: "תהיה בטוח, התחושה טבעית ב-100%, ללא חוסר תחושה מעצבן." } },
        { ...docs.mahmoud, text: { ar: "هذا اعتقاد خاطئ شائع بسبب المنتجات التجارية القديمة. رايز لا يحتوي على مخدر موضعي بل يعتمد على التنشيط الذكي للتروية دون فقدان الإحساس الطبيعي.", en: "A common misconception due to old commercial products. Rise doesn't contain local anesthetics, it relies on smart blood flow stimulation without losing natural sensation.", he: "טעות נפוצה בגלל מוצרים מסחריים ישנים. רייז אינו מכיל חומרי הרדמה מקומיים, הוא מסתמך על גירוי חכם של זרימת הדם מבלי לאבד תחושה טבעית." } },
        { name: { ar: "تركي", en: "Turki", he: "טורקי" }, text: { ar: "فعلاً الإحساس طبيعي جداً وهذا أسعدني بعد التجربة.", en: "Indeed, sensation is very natural, which made me happy.", he: "אכן, התחושה טבעית מאוד, מה ששימח אותי." } },
        { name: { ar: "الرحال", en: "Traveler", he: "נוסע" }, text: { ar: "منتج رائع وصدق الدفع عند الاستلام يطمن.", en: "Great product, cash on delivery is reassuring.", he: "מוצר נהדר, תשלום במסירה זה מרגיע." } }
      ] 
    },
    { 
      name: { ar: "يوسف خليل", en: "Yousef Khalil", he: "יוסף חליל" }, 
      text: { ar: "كم يدوم المفعول بالضبط؟ وهل لازم اغسله قبل اللقاء؟", en: "How long does the effect last? Do I need to wash it off?", he: "כמה זמן נמשכת ההשפעה? האם עלי לשטוף את זה?" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "ماجد المطيري", en: "Majed Al-Mutairi", he: "מאג'ד אל-מוטיירי" }, text: { ar: "المفعول يستمر لساعات طويلة والامتصاص كامل.", en: "The effect lasts for long hours and absorption is complete.", he: "ההשפעה נמשכת שעות ארוכות והספיגה מלאה." } },
        { ...docs.rami, text: { ar: "المفعول الفعلي يبدأ خلال 15 دقيقة ويمتد لساعات. ولا داعي لغسله أبداً لأن الجلد يمتصه بالكامل.", en: "Effect starts in 15 mins and lasts hours. No need to wash it off as the skin absorbs it fully.", he: "ההשפעה מתחילה ב-15 דקות ונמשכת שעות. אין צורך לשטוף כי העור סופג אותו במלואו." } },
        { name: { ar: "عبدالله", en: "Abdullah", he: "עבדאללה" }, text: { ar: "توضيح ممتاز ودقيق، شكراً لسرعة الرد.", en: "Excellent and precise clarification, thanks for the fast reply.", he: "הסבר מצוין ומדויק, תודה על התגובה המהירה." } },
        { name: { ar: "F.S", en: "F.S", he: "F.S" }, text: { ar: "ريحته كيف يا اخوان؟", en: "How is its smell guys?", he: "איך הריח חברים?" } },
        { name: { ar: "محمد الزهراني", en: "Mohammed Al-Zahrani", he: "מוחמד אל-זהראני" }, text: { ar: "بدون ريحة، تمتصه البشرة بسرعة.", en: "Odorless, absorbed quickly by skin.", he: "ללא ריח, נספג במהירות על ידי העור." } }
      ] 
    },
    { 
      name: { ar: "سالم المري", en: "Salem Al-Marri", he: "סאלם אל-מארי" }, 
      text: { ar: "التوصيل كان سريع جداً والمنتج فعاليته ممتازة وبدون أي تخدير، شكراً لكم من القلب.", en: "Delivery was very fast and product is highly effective without numbness. Thank you.", he: "המשלוח היה מהיר מאוד והמוצר יעיל ביותר ללא חוסר תחושה. תודה רבה." }, 
      stars: 5, 
      replies: [
        { ...docs.sara, text: { ar: "شكراً لثقتك بمركزنا، نتمنى لك دوام الصحة والعافية.", en: "Thank you for your trust, wishing you good health.", he: "תודה על האמון שלך, מאחלת לך בריאות טובה." } },
        { name: { ar: "طارق السبيعي", en: "Tariq Al-Subaie", he: "טארק אל-סובאי" }, text: { ar: "التوصيل سريع والخصوصية عندهم ممتازة جداً.", en: "Fast delivery and privacy is excellent.", he: "משלוח מהיר והפרטיות מעולה." } },
        { name: { ar: "ناصر", en: "Nasser", he: "נאצר" }, text: { ar: "كم استغرق الشحن بالضبط يا اخوان؟", en: "How long did shipping take exactly?", he: "כמה זמן לקח המשלוח בדיוק?" } }
      ] 
    },
    { 
      name: { ar: "فهد العتيبي", en: "Fahd Al-Otaibi", he: "פאהד אל-עותייבי" }, 
      text: { ar: "هل استخدامه باستمرار يسبب تعود؟ يعني هل ممكن بعدين ما اقدر بدونه؟", en: "Does continuous use cause habituation? Can I perform without it later?", he: "האם שימוש רציף גורם להתרגלות? האם אוכל לתפקד בלעדיו מאוחר יותר?" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "مشعل الرشيدي", en: "Meshal Al-Rashidi", he: "משעל אל-ראשידי" }, text: { ar: "استخدمته لفترات ولم ألاحظ أي تعود نهائياً.", en: "Used it for periods and didn't notice any habituation.", he: "השתמשתי בזה לתקופות ולא שמתי לב לשום התרגלות." } },
        { ...docs.sara, text: { ar: "التركيبة آمنة للاستخدام المتكرر ولا تسبب أي إدمان عضوي أو تعود وظائفي نهائياً.", en: "The formula is safe for repeated use and doesn't cause any addiction or habituation.", he: "הנוסחה בטוחה לשימוש חוזר ואינה גורמת להתמכרות או התרגלות." } },
        { name: { ar: "م.خ", en: "M.Kh", he: "מ.ח" }, text: { ar: "شكرا دكتورة، هذا كان سؤالي بالضبط.", en: "Thanks doctor, that was exactly my question.", he: "תודה דוקטור, זו הייתה בדיוק השאלה שלי." } },
        { name: { ar: "أبو يوسف", en: "Abu Yousef", he: "אבו יוסף" }, text: { ar: "أنا استخدمه من 3 شهور وكل شيء تمام التمام.", en: "Using it for 3 months, everything is perfect.", he: "משתמש בזה כבר 3 חודשים, הכל מושלם." } }
      ] 
    },
    { 
      name: { ar: "عبدالإله", en: "Abdulilah", he: "עבדולילה" }, 
      text: { ar: "عمري 62 سنة، هل سيفيدني أم أنه مخصص للشباب فقط؟", en: "I am 62 years old, will it benefit me or is it for youth only?", he: "אני בן 62, האם זה יועיל לי או שזה מיועד לצעירים בלבד?" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "سعيد القحطاني", en: "Saeed Al-Qahtani", he: "סעיד אל-קחטאני" }, text: { ar: "أنصحك به وبقوة، النتائج ممتازة لكافة الأعمار.", en: "Highly recommend it, excellent results for all ages.", he: "ממליץ בחום, תוצאות מעולות לכל הגילאים." } },
        { ...docs.tariq, text: { ar: "المنتج فعال جداً ومناسب للأعمار المتقدمة. شريحة واسعة من عملائنا فوق الستين ويحققون نتائج ممتازة.", en: "Very effective and suitable for advanced ages. Many of our clients are over 60 with excellent results.", he: "יעיל מאוד ומתאים לגילאים מתקדמים. לקוחות רבים שלנו מעל גיל 60 ומשיגים תוצאות מצוינות." } },
        { name: { ar: "عبدالإله", en: "Abdulilah", he: "עבדולילה" }, text: { ar: "توكلت على الله وطلبت الان.", en: "Relied on God and ordered now.", he: "סמכתי על אלוהים והזמנתי עכשיו." } }
      ] 
    },
    { 
      name: { ar: "ياسر عبدالله", en: "Yasser Abdullah", he: "יאסר עבדאללה" }, 
      text: { ar: "افضل منتج جربته حتى الآن، يعطيك ثقة كبيرة جداً والنتيجة تدوم لفترة طويلة.", en: "Best product I tried, gives immense confidence and long-lasting results.", he: "המוצר הטוב ביותר שניסיתי, מעניק ביטחון עצום ותוצאות לאורך זמן." }, 
      stars: 5, 
      replies: [
        { ...docs.mahmoud, text: { ar: "سعداء جداً بسماع هذه التجربة الإيجابية، شكراً لك.", en: "Very happy to hear this positive experience, thank you.", he: "שמחים מאוד לשמוע על הניסיון החיובי הזה, תודה לך." } },
        { name: { ar: "وايل العنزي", en: "Wael Al-Enezi", he: "וואאל אל-ענזי" }, text: { ar: "تجربة ناجحة بكل المقاييس.", en: "Successful experience by all standards.", he: "חוויה מוצלחת בכל קנה מידה." } },
        { name: { ar: "N.M", en: "N.M", he: "N.M" }, text: { ar: "انا شفت الإعلان بالصدفة والحمدلله توفقت فيه.", en: "Saw the ad by chance and thankfully it worked out.", he: "ראיתי את המודעה במקרה ולשמחתי זה עבד מצוין." } }
      ] 
    },
    { 
      name: { ar: "تركي", en: "Turki", he: "טורקי" }, 
      text: { ar: "أنا استخدمت كريمات ثانية وسببت لي صداع واحمرار بالوجه.. هل هذا نفس الشيء؟", en: "I used other creams and they caused headaches and facial redness. Is this the same?", he: "השתמשתי בקרמים אחרים והם גרמו לי לכאבי ראש ואדמומיות בפנים. האם זה אותו דבר?" }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "سعود الدوسري", en: "Saud Al-Dossari", he: "סעוד אל-דוסארי" }, text: { ar: "لا يوجد أي صداع أو أعراض جانبية نهائياً مع هذا المنتج.", en: "No headaches or side effects at all with this product.", he: "אין כאבי ראש או תופעות לוואי בכלל עם המוצר הזה." } },
        { ...docs.mahmoud, text: { ar: "لا أبداً. الصداع والاحمرار يحدث بسبب الحبوب الفموية، أما رايز فعلاج موضعي خارجي نقي وآمن تماماً.", en: "Not at all. Headaches occur with oral pills. Rise is a pure and totally safe topical treatment.", he: "ממש לא. כאבי ראש מתרחשים עקב כדורים. רייז הוא טיפול מקומי טהור ובטוח לחלוטין." } },
        { name: { ar: "بن قاسم", en: "Bin Qasim", he: "בן קאסם" }, text: { ar: "صدقت دكتور انا مالي غنى عنه الحين.", en: "True doctor, I can't do without it now.", he: "נכון דוקטור, אני לא יכול בלעדיו עכשיו." } }
      ] 
    }
  ];
  ...
  // شاشة التحميل: تنتظر اكتمال تحميل الصفحة مع حد أقصى احتياطي
  ...
  setTimeout(hideSiteLoader, 4000);
  ...
  const qtySelect = document.getElementById("qtySelect"); const totalPrice = document.getElementById("totalPrice"); const prices = { "1": 100, "2": 150, "3": 250 };
  const updateTotal = () => { if (!qtySelect || !totalPrice) return; const v = qtySelect.value || "1"; const curr = (dict.currency && dict.currency[currentLang]) || dict.currency.ar; totalPrice.textContent = `${prices[v] ?? 100} ${curr}`; };
  ...
  const stickyOrderButton = stickyBottomBar ? stickyBottomBar.querySelector(".sbb-btn") : null;
  const setStickyOrderHidden = (hidden) => { if (stickyBottomBar) stickyBottomBar.classList.toggle("is-hidden", !!hidden); };
  if (stickyBottomBar && orderPanel) {
    if ("IntersectionObserver" in window) {
      const stickyOrderObserver = new IntersectionObserver((entries) => {
        entries.forEach((entry) => setStickyOrderHidden(entry.isIntersecting));
      }, { threshold: 0.01 });
      stickyOrderObserver.observe(orderPanel);
    }
    if (stickyOrderButton) stickyOrderButton.addEventListener("click", () => setStickyOrderHidden(true));
  }
