(() => {
  ...
  // مصفوفة التقييمات مع ردود كثيفة وواقعية ونصف سلبية واستفسارات
  const seedReviews = [
    { 
      name: "خالد عبدالرحمن", 
      ...
      replies: [
        ...
        { name: "خالد عبدالرحمن", text: "جلس ساعات طويلة بدون أي مشكلة." }
      ]
    },
    { 
      name: "سالم المري", 
    ...
    { 
      ...
      stars: 5,
      replies: [
        { name: "متردد", text: "أخوي ياسر، يطول لين يبدأ مفعوله؟" },
        { name: "ياسر عبدالله", text: "تقريباً 15 إلى 20 دقيقة وتكون أمورك تمام." },
        { name: "متردد", text: "ممتاز، يعطيك العافية" }
      ]
    },
    { 
      name: "عمر الفاروق", 
      ...
      stars: 5,
      replies: [
        { name: "زائر", text: "هل هو أصلي فعلاً زي حق الصيدليات؟" },
    ...
    { 
      ...
      stars: 5,
      replies: [
        { name: "زائر", text: "الحمدلله، أنا تعقدت من الحبوب وكانت تجيب لي صداع نصفي." },
    ...
    { 
      ...
      stars: 5,
      replies: [
        { name: "مجهول", text: "المندوب سألك عن المحتوى؟" },
        { name: "عبدالله العتيبي", text: "لا أبداً، المندوب بس سلمني الكيس وأخذ الحساب." },
        { name: "مجهول", text: "طيب الفاتورة وش مكتوب عليها؟" },
    ...
    { name: "حسن العمري", text: { ar: "ممتاز صراحة والضمان الذهبي شجعني أطلبه، وما ندمت أبداً." }, stars: 5 },
    { name: "محمد الشمري", text: { ar: "استخدمته اليوم وما صدقت النتيجة، تأخير عجيب وصلابة قوية جداً." }, stars: 5 },
    { name: "سامي المطيري", text: { ar: "اللي متردد يطلبه وهو مغمض، أفضل بديل لحبوب الفياجرا اللي كانت تجيب لي صداع." }, stars: 5 },
    { name: "راشد الغامدي", text: { ar: "جودة المنتج واضحة من أول لمسة، شكراً لمركز الارتقاء على هذا الاختراع." }, stars: 5 },
    { name: "طلال العنزي", text: { ar: "معي ضغط وكنت خايف، لكن فعلاً منتج آمن 100% وما حسيت بأي دوخة أو تعب." }, stars: 5 },
    { name: "وليد جابر", text: { ar: "خدمة العملاء على الواتساب قمة في الاحترام ورد سريع، والمنتج أصلي." }, stars: 5 },
    { name: "أحمد اليامي", text: { ar: "مفعوله يطول وهذا أفضل شيء فيه، تاخذ راحتك بدون توتر واستعجال." }, stars: 5 },
    { name: "سعيد باوزير", text: { ar: "تغليف ممتاز وسري جداً، المندوب سلمه لي يداً بيد بأسلوب راقي." }, stars: 5 },
    { name: "حسين العبدالله", text: { ar: "استخدمته كورس كامل ولاحظت تحسن كبير حتى في الأيام اللي ما استخدمه فيها." }, stars: 5 },
    { name: "عبدالرحمن الماجد", text: { ar: "حل جذري لمشكلة الارتخاء، يبدأ المفعول في 15 دقيقة بالظبط زي ما قالوا." }, stars: 5 },
    { name: "فواز السبيعي", text: { ar: "تغير جذري في حياتي الزوجية، يعلم الله اني ادعي لكم من كل قلبي." }, stars: 5 },
    { name: "يوسف القاسم", text: { ar: "أهم ميزة انه ما يخدر، تحس بكل شيء بشكل طبيعي جداً لكن مع تأخير قوي." }, stars: 5 },
    { name: "صالح الفرج", text: { ar: "ممتاز جداً وسهل الاستخدام، وما يحتاج تغسله بعدين لأنه آمن على البشرة." }, stars: 5 },
    { name: "رياض الزهراني", text: { ar: "كنت اعاني من سرعة القذف من سنوات، رايز حل لي المشكلة من أول استخدام." }, stars: 5 },
    { name: "نايف العسيري", text: { ar: "بصراحة ما توقعت هالنتيجة، منتج جبار ويستاهل الانتظار، شكرا لكم." }, stars: 5 },
    { name: "عمار الجدعاني", text: { ar: "أكثر شيء عجبني ان الدفع عند الاستلام والتغليف ماعليه أي شعار او اسم." }, stars: 5 },
    { name: "بدر الشريف", text: { ar: "ما سبب لي أي حساسية او احمرار وهذا كان هاجسي الوحيد. آمن جداً." }, stars: 5 },
    { name: "تركي السالم", text: { ar: "اللي يعاني من الضغط مثلي هذا هو الحل المناسب، ما يرفع الضغط أبداً." }, stars: 5 },
    { name: "وسيم خ.", text: { ar: "أنصح باستخدامه قبل اللقاء بـ 20 دقيقة يعطي نتيجة أقوى بكثير." }, stars: 5 },
    { name: "منصور الحارثي", text: { ar: "المنتج اصلي مية بالمية، حليتوا لي مشكلة كبيرة يعطيك العافية." }, stars: 5 },
    { name: "مروان ك.", text: { ar: "أول مرة أقيم منتج في النت، بس صراحة يستاهل كل كلمة مدح انقالت فيه." }, stars: 5 },
    { name: "جابر السعد", text: { ar: "التأخير فيه طبيعي ومريح مو مزعج، يخليك تتحكم بوقتك بشكل كامل." }, stars: 5 },
    { name: "فهد العبدلي", text: { ar: "وصلت الشحنة مغلفة بغلاف أسود عازل تماماً، اشكركم على حفظ الخصوصية." }, stars: 5 },
    { name: "أنس اليحيى", text: { ar: "استخدمته مرتين للآن والنتيجة ثابتة وقوية في المرتين." }, stars: 5 },
    { name: "بشار محمود", text: { ar: "وداعا للحبوب والصداع، هذا الاختراع الطبي هو الأفضل حالياً في السوق." }, stars: 5 },
    { name: "زيد الهاجري", text: { ar: "ثقتي بنفسي زادت بشكل ملحوظ، زوجتي لاحظت الفرق الكبير من أول يوم." }, stars: 5 },
    { name: "ممدوح الشمري", text: { ar: "كنت أبحث عن منتج يطول المدة بدون تخدير وهذا وفى وكفى." }, stars: 5 },
    { name: "نادر الدوسري", text: { ar: "منتج بطل بكل معنى الكلمة، وفريق المبيعات تعاملهم احترافي جداً." }, stars: 5 },
    { name: "قصي ع.", text: { ar: "تأثير سريع جداً، مجرد ربع ساعة وتكون بقمة الجاهزية." }, stars: 5 },
    { name: "أسامة جابر", text: { ar: "الدفع عند الاستلام ميزة رهيبة ريحتني كثير من الدفع الالكتروني." }, stars: 5 },
    { name: "إياد المحمد", text: { ar: "طلبت عبوة وحدة للتجربة، والآن برجع أطلب عرض الـ 3 عبوات." }, stars: 5 },
    { name: "مهند س.", text: { ar: "من أفضل الخيارات الطبية، استخدمته وأنا مرتاح نفسياً لأنه ما يدخل الدم." }, stars: 5 },
    { name: "غسان ن.", text: { ar: "اللي يبي يرتاح من سرعة الانتهاء ياخذ هذا المنتج وهو مرتاح البال." }, stars: 5 },
    { name: "وائل الشريف", text: { ar: "مفعول الانتصاب فيه جدا قوي صراحة، كأني رجعت لسن العشرين." }, stars: 5 },
    { name: "جمال الروبي", text: { ar: "الخدمة ممتازة والمنتج فعاليته عالية، شكرا مركز الارتقاء." }, stars: 5 },
    { name: "حاتم ع.", text: { ar: "الضمان الذهبي خلاني اجربه بدون خوف، وطلعت النتيجة أحسن من المتوقع." }, stars: 5 },
    { name: "باسم ت.", text: { ar: "تأخير ملحوظ جداً، يعطيك القدرة تكمل للنهاية بكل ثقة." }, stars: 5 },
    { name: "صقر أ.", text: { ar: "ممتاز جداً للي عندهم ضعف انتصاب، يقوي الصلابة بشكل واضح." }, stars: 5 },
    { name: "فراس ق.", text: { ar: "منتج جبار صراحة، يستاهل كل ريال يندفع فيه." }, stars: 5 },
    { name: "رائد ص.", text: { ar: "أهم شيء انه طبي وما منه خوف، استخدمه بانتظام واموري ممتازة." }, stars: 5 },
    { name: "أكرم ش.", text: { ar: "التوصيل للمنزل بسيارة عادية ومندوب محترم، محد حس بشيء ابداً." }, stars: 5 },
    { name: "عماد ز.", text: { ar: "تأثيره يدوم وقت طويل، يعطيك أريحية تامة في التعامل." }, stars: 5 },
    { name: "كريم و.", text: { ar: "ريحته مقبولة وامتصاصه سريع، ما يترك أي أثر دهني على الجلد." }, stars: 5 },
    { name: "لؤي م.", text: { ar: "جربت بخاخات كثير لكن هذا الوحيد اللي ما فقدني الإحساس بالكامل." }, stars: 5 },
    { name: "هيثم ب.", text: { ar: "نتيجة فورية زي السحر، اشكر القائمين على هذا المنتج الجميل." }, stars: 5 },
    { name: "شاكر ر.", text: { ar: "مرضى القلب يقدرون يستخدمونه بأمان تام، سألت دكتوري قبل ما أطلبه." }, stars: 5 },
    { name: "جلال د.", text: { ar: "منتج خرافي يغير الروتين بالكامل، أنصح كل زوجين بتجربته." }, stars: 5 },
    { name: "عيسى ك.", text: { ar: "توصيل سريع، تغليف سري، وفعالية أكيدة.. ايش نبي أكثر من كذا؟" }, stars: 5 },
    { name: "أمجد ط.", text: { ar: "بصراحة في البداية كنت متخوف لكن التجربة خير برهان، بطل بطل بطل." }, stars: 5 },
    { name: "تيسير ع.", text: { ar: "شكرا لكم على المصداقية، فعلا 15 دقيقة وتكون النتيجة جاهزة 100%." }, stars: 5 }
  ];
