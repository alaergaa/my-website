(() => {
  ...
  const dict = {
    ...
    clinicLocation: { ar: "📍 العنوان: سلطنة عُمان – مسقط – الخوير – عمارة الزهور – الطابق الرابع. • 🕒 ساعات العمل: 7:00 صباحاً – 7:00 مساءً • 📅 الجمعة: مغلق", en: "📍 Address: Sultanate of Oman – Muscat – Al Khuwair – Al Zuhur Building – 4th Floor. • 🕒 Working Hours: 7:00 AM – 7:00 PM • 📅 Friday: Closed", he: "📍 כתובת: סולטנות עומאן – מוסקט – אל-חוויר – בניין אל-זוהור – קומה רביעית. • 🕒 שעות פעילות: 07:00–19:00 • 📅 יום שישי: סגור" },
    ...
    goldGuaranteeHtml: {
      ar: `<div class="gold-icon">🏆</div>
           ...
           <ul class="bulletList" style="text-align:right; font-size:13.5px; color:#78350f; background:rgba(255,255,255,0.4); padding:12px 24px; border-radius:12px;">
             <li>⏱️ <strong>اختبار الـ 15 دقيقة:</strong> إذا لم تحصل على قوة وتأخير ملحوظ خلال 15 دقيقة، لك الحق في استرداد كل ريال قطري.</li>
    ...
    aboutHtml: {
      ar: `<div class="sectionRich">
            <p class="richIntro">نحن في <strong>"مركز الارتقاء الطبي"</strong> لسنا مجرد نقطة بيع، بل صرح طبي رائد وموثوق في مسقط. كرسنا جهودنا لتقديم حلول صحية مبتكرة تركز حصرياً على "صحة الرجل"، وتوفير علاجات جذرية وآمنة لمشاكل الضعف والارتخاء.</p>
      ...
      en: `<div class="sectionRich">
            <p class="richIntro">At <strong>Medical Elevation Center</strong>, we are a leading and trusted medical institution in Muscat dedicated exclusively to men's health.</p>
            <div class="modern-about">
      ...
      he: `<div class="sectionRich">
            <p class="richIntro">ב-<strong>מרכז העלייה הרפואי</strong>, אנו מוסד רפואי מוביל ואמין במוסקט, המוקדש בלעדית לבריאות הגבר.</p>
            <div class="modern-about">
    ...
    footerInfo: {
      ar: `<div class="fc-welcome">نحن هنا من أجلك، لتقديم رعاية صحية تليق بك وبثقتك.</div><p>📍 <strong>العنوان:</strong> سلطنة عُمان – مسقط – الخوير – عمارة الزهور – الطابق الرابع.</p><p>📞 <strong>للتواصل والواتساب:</strong> <span style="direction:ltr; display:inline-block;">+972512865105</span></p><p>🕒 <strong>ساعات العمل:</strong> 7:00 صباحاً – 7:00 مساءً</p><p>📅 <strong>الجمعة:</strong> مغلق</p>`,
      en: `<div class="fc-welcome">We are here for you, providing health care worthy of your trust.</div><p>📍 <strong>Address:</strong> Sultanate of Oman – Muscat – Al Khuwair – Al Zuhur Building – 4th Floor.</p><p>📞 <strong>WhatsApp:</strong> <span style="direction:ltr; display:inline-block;">+972512865105</span></p><p>🕒 <strong>Working Hours:</strong> 7:00 AM – 7:00 PM</p><p>📅 <strong>Friday:</strong> Closed</p>`,
      he: `<div class="fc-welcome">אנחנו כאן בשבילך, מספקים שירותי בריאות הראויים לאמון שלך.</div><p>📍 <strong>כתובת:</strong> סולטנות עומאן – מוסקט – אל-חוויר – בניין אל-זוהור – קומה רביעית.</p><p>📞 <strong>וואטסאפ:</strong> <span style="direction:ltr; display:inline-block;">+972512865105</span></p><p>🕒 <strong>שעות פעילות:</strong> 07:00–19:00</p><p>📅 <strong>יום שישי:</strong> סגור</p>`
    },
    faqHtml: {
    ...
    currency: { ar: "ريال قطري", en: "QAR", he: "QAR" },
    price1: { ar: "121 ريال قطري", en: "121 QAR", he: "121 QAR" },
    price2: { ar: "181 ريال قطري", en: "181 QAR", he: "181 QAR" },
    price3: { ar: "302 ريال قطري", en: "302 QAR", he: "302 QAR" },
    ...
    mapPinBadge: { ar: "📍 مركز الارتقاء الطبي — سلطنة عُمان – مسقط – الخوير – عمارة الزهور – الطابق الرابع", en: "📍 Medical Elevation Center — Sultanate of Oman – Muscat – Al Khuwair – Al Zuhur Building – 4th Floor", he: "📍 מרכז העלייה הרפואי — סולטנות עומאן – מוסקט – אל-חוויר – בניין אל-זוהור – קומה רביעית" },
  ...
  const qtySelect = document.getElementById("qtySelect"); const totalPrice = document.getElementById("totalPrice"); const prices = { "1": 121, "2": 181, "3": 302 };
  const updateTotal = () => { if (!qtySelect || !totalPrice) return; const v = qtySelect.value || "1"; const curr = (dict.currency && dict.currency[currentLang]) || dict.currency.ar; totalPrice.textContent = `${prices[v] ?? 121} ${curr}`; };
