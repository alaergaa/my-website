(() => {
  ...
  const docs = {
    ...
    mahmoud: { name: { ar: "د. محمود صبري", en: "Dr. Mahmoud S.", he: "ד״ר מחמוד ס." }, img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=faces", status: "online" }
  };
  ...
  const seedReviews = [
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.tariq, text: { ar: "أهلاً بك أخي الكريم. لا تقلق أبداً، تركيبة 'رايز' صُممت كعلاج موضعي خارجي لا يدخل في مجرى الدم الكلي، لذلك هي آمنة تماماً لمرضى الضغط ولا تتعارض مع الأدوية." } },
        { ...docs.rami, text: { ar: "نؤكد كلام الزميل د. طارق. بحكم التخصص في أمراض الباطنة والضغط، لعدم وجود امتصاص جهازي واسع، فهو الخيار الأكثر أماناً للمرضى." } }
      ] 
    },
    { 
      ...
      stars: 4, 
      replies: [ 
        { ...docs.rami, text: { ar: "حياك الله. نعم فعال جداً في حالتك. مرضى السكري يعانون من ضعف التروية الدموية الطرفية، ورايز يعمل موضعياً لتنشيط التدفق الدموي فوراً." } },
        { ...docs.mahmoud, text: { ar: "بالتأكيد، أنصحك بالالتزام بالتدليك الجيد لمدة دقيقة لتحقيق أقصى استجابة وعودة التروية الطبيعية." } }
      ] 
    },
    { 
    ...
    { 
      ...
      replies: [ 
        ...
        { ...docs.rami, text: { ar: "صحيح، الامتصاص السريع ميزة كبرى تمنع انتقال أي أثر للطرف الآخر نهائياً." } }
      ] 
    },
    { 
    ...
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.rami, text: { ar: "سؤال علمي ممتاز. التركيبة آمنة للاستخدام المتكرر ولا تسبب أي إدمان عضوي أو تعود وظائفي. يمكنك استخدامه متى شئت." } },
        { ...docs.mahmoud, text: { ar: "تماماً، لا يوجد أي تعود جسدي أو اعتماد كيميائي نهائياً." } }
      ] 
    },
    { 
    ...
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.mahmoud, text: { ar: "لا أبداً. الصداع والاحمرار يحدث بسبب الحبوب الفموية الموسعة للأوعية، أما رايز فعلاج موضعي خارجي نقي وآمن." } }
      ] 
    },
    { 
    ...
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.mahmoud, text: { ar: "لا، المنتج مصنف كمستحضر عناية طبية شخصية ولا يتطلب وصفة طبية لصرفه." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.tariq, text: { ar: "هذه الحالة بالتحديد هي ما تستهدفها التركيبة المتقدمة لتعطيك تحكماً مضاعفاً ووقتاً مثالياً." } },
        { ...docs.rami, text: { ar: "ستلاحظ الفارق الإيجابي من أول استخدام بحول الله." } }
      ] 
    },
    { 
