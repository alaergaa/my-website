(() => {
  ...
  const dict = {
    ...
    price1: { ar: "200 شيكل", en: "200 ILS", he: "200 ₪" },
    price2: { ar: "300 شيكل", en: "300 ILS", he: "300 ₪" },
    price3: { ar: "450 شيكل", en: "450 ILS", he: "450 ₪" },
  ...
  const qtySelect = document.getElementById("qtySelect"); const totalPrice = document.getElementById("totalPrice"); const prices = { "1": 200, "2": 300, "3": 450 };
  const updateTotal = () => { if (!qtySelect || !totalPrice) return; const v = qtySelect.value || "1"; const curr = (dict.currency && dict.currency[currentLang]) || dict.currency.ar; totalPrice.textContent = `${prices[v] ?? 200} ${curr}`; };
