(() => {
  ...
  const docs = {
    ...
    mahmoud: { name: { ar: "د. محمود صبري", en: "Dr. Mahmoud S.", he: "ד״ר מחמוד ס." }, img: "https://images.unsplash.com/photo-1527613426441-2da17477366d?w=150&h=150&fit=crop&crop=faces", status: "online" }
  };

  const seedReviews = [
    // --- استشارات مكثفة مع ردود متداخلة من أطباء وزوار ---
    { 
      name: { ar: "عيسى محمد", en: "Issa M." }, 
      text: { ar: "هل يتعارض المنتج مع أدوية الضغط؟ أنا استخدم حبوب ضغط يومياً وخايف يسبب لي مضاعفات." }, 
      stars: 5, 
      replies: [ 
        { name: { ar: "زاهي طارق", en: "Zahi T." }, text: { ar: "نفس تخوفي والله يا عيسى، ياليت الدكتور يفيدنا بشكل قاطع." } },
        { ...docs.tariq, text: { ar: "أهلاً بك أخي عيسى والأخ زاهي. لا تقلقوا أبداً، تركيبة 'رايز' صُممت كعلاج موضعي خارجي لا يدخل في مجرى الدم الكلي، لذلك هي آمنة 100% لمرضى الضغط ولا تتعارض مع أي أدوية تتناولونها." } },
        { ...docs.rami, text: { ar: "أؤكد كلام الزميل د. طارق. بحكم تخصصي في القلب والضغط، أقولها لكم مطمئناً: لعدم وجود امتصاص جهازي واسع، فهو الخيار الأكثر أماناً." } }
      ] 
    },
    { 
      ...
      stars: 4, 
      replies: [ 
        { ...docs.rami, text: { ar: "حياك الله أبو سيف. نعم فعال جداً في حالتك. مرضى السكري يعانون من ضعف التروية الدموية الطرفية، ورايز يعمل موضعياً لتنشيط التدفق الدموي فوراً." } },
        { ...docs.mahmoud, text: { ar: "بالتأكيد أبو سيف، أنصحك بتجربته مع الالتزام بالتدليك الجيد لمدة دقيقة لتحقيق أقصى استفادة." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { name: { ar: "سلطان", en: "Sultan" }, text: { ar: "ما شاء الله يا خالد، هل تحس بقشعريرة أو تخدير مزعج؟" }, },
        { name: { ar: "خالد عبدالرحمن", en: "Khaled A." }, text: { ar: "أبدًا يا سلطان، الإحساس طبيعي 100% وكأنك لم تضع شيئاً سوى أن الصلابة مضاعفة." }, },
        { ...docs.tariq, text: { ar: "هذا هو الأثر الطبي المطلوب تماماً يا سلطان، تقليل الحساسية المفرطة مع الاحتفاظ بالمتعة الكاملة." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.mahmoud, text: { ar: "هذا اعتقاد خاطئ شائع بسبب البخاخات التجارية القديمة. رايز لا يحتوي على مخدر موضعي بل يعتمد على التنشيط الذكي للتروية." } },
        { name: { ar: "ماجد الحربي", en: "Majed H." }, text: { ar: "فعلاً كلام الدكتور صحيح، جربته وما في أي تخدير نهائي." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.tariq, text: { ar: "المفعول الفعلي يبدأ خلال 15 دقيقة ويمتد لساعات. ولا داعي لغسله أبداً لأن الجلد يمتصه بالكامل دون ترك أي أثر أو لزوجة." } },
        { ...docs.rami, text: { ar: "صحيح د. طارق، الامتصاص السريع ميزة كبرى تمنع انتقال أي أثر للطرف الآخر." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [
        { name: { ar: "فارس", en: "Faris" }, text: { ar: "كم يوم استغرق التوصيل عندك يا سالم؟" } },
        { name: { ar: "سالم المري", en: "Salem M." }, text: { ar: "خلال 24 ساعة بالضبط وكان عندي بمسقط." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.rami, text: { ar: "سؤال ذكي فهد. التركيبة آمنة للاستخدام المتكرر ولا تسبب أي إدمان عضوي أو تعود وظائفي. يمكنك استخدامه متى شئت." } },
        { ...docs.mahmoud, text: { ar: "تماماً، لا يوجد أي تعود جسدي نهائياً." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.tariq, text: { ar: "المنتج فعال جداً ومناسب للأعمار المتقدمة أخي عبدالإله. شريحة واسعة من عملائنا فوق الستين ويحققون نتائج مذهلة." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [
        { name: { ar: "زياد", en: "Ziad" }, text: { ar: "هل ينفع استخدامه يومياً لو اردت؟" } },
        { ...docs.tariq, text: { ar: "نعم أخي زياد، ولكن يفضل حسب الحاجة لضمان أفضل استجابة دائماً." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.mahmoud, text: { ar: "لا أبداً أخي تركي. الصداع والاحمرار يحدث بسبب الحبوب الفموية الموسعة للأوعية، أما رايز فعلاج موضعي خارجي نقي." } }
      ] 
    },
    { 
    ...
    { 
      ...
      text: { ar: "هل ريحته قوية؟ زوجتي تنزعج من الروائح الطبية." }, 
      stars: 4, 
      replies: [ 
    ...
    { 
      ...
      text: { ar: "إذا طلبته، كيف تضمنون لي السرية؟ المندوب بيعرف وش داخل الكيس؟" }, 
      stars: 5, 
      replies: [ 
        { ...docs.tariq, text: { ar: "نلتزم بسرية تامة مطلقة. الشحنة تغلف بأسود مبهم تماماً ولا يكتب عليها اسم المنتج، والمندوب نفسه لا يعلم المحتوى." } }
      ] 
    },
    { 
    ...
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.mahmoud, text: { ar: "لا يا صالح، المنتج مصنف كمستحضر عناية طبية شخصية ولا يتطلب وصفة طبية." } }
      ] 
    },
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.tariq, text: { ar: "نعم وليد، هذه الحالة بالتحديد هي ما تستهدفها التركيبة المتقدمة لتعطيك تحكماً مضاعفاً." } },
        { ...docs.rami, text: { ar: "ستلاحظ الفرق من أول استخدام بحول الله." } }
      ] 
    },
    { 
    ...
    { 
      ...
      stars: 4, 
      replies: [ 
        { ...docs.rami, text: { ar: "أخي بدر، نظراً لتركيزه العالي فأنت تحتاج لكمية بحجم حبة البازلاء فقط، لذا تكفي العبوة حتى 30 استخداماً كاملاً." } }
      ] 
    },
    { 
    ...
    { 
      ...
      stars: 5, 
      replies: [ 
        { ...docs.tariq, text: { ar: "نعم حقيقي 100% وأمام الجميع. إذا لم تلاحظ النتيجة المرجوة خلال 15 دقيقة، استرد أموالك فوراً وبكل سهولة." } }
      ] 
    },
    { 
