(() => {
  ...
  // 73 تقييمًا طبيعيًا ومدروسًا للعملاء مع ردود واقعية ونصف سلبية
  const seedReviews = [
    { 
      name: "خالد عبدالرحمن", 
    ...
    { name: "ياسر عبدالله", text: { ar: "افضل منتج جربته حتى الآن، يعطيك ثقة كبيرة جداً والنتيجة تدوم لفترة طويلة." }, stars: 5 },
    { name: "عمر الفاروق", text: { ar: "كنت متردد في البداية لكن بعد التجربة تأكدت انه منتج أصلي وقوي ويستحق كل ريال." }, stars: 5 },
    { name: "أبو فهد", text: { ar: "يستحق كل قرش، صلابة غير طبيعية ووقت أطول بكثير." }, stars: 5 },
    { name: "طارق س.", text: { ar: "بدون أي أعراض جانبية، لا صداع ولا خفقان. هذا اللي كنت ابحث عنه من زمان." }, stars: 5 },
    { name: "محمود خليل", text: { ar: "المفعول يبدأ بسرعة، تقريبا 15 دقيقة وتكون جاهز تماماً. خدمة العملاء راقية جداً." }, stars: 5 },
    { name: "عبدالله العتيبي", text: { ar: "التغليف جاني أسود بالكامل ومحد عرف وش داخله، الخصوصية عندهم 10/10." }, stars: 5 },
    { name: "فيصل الناصر", text: { ar: "ممتاز جداً لمرضى السكري، استخدمته وما أثر علي أبد ولا على دقات قلبي." }, stars: 5 },
    { 
      name: "سعد الشهراني", 
      ...
      replies: [
        ...
        { name: "سعد الشهراني", text: "أنا بمدينة ثانية يمكن عشان كذا تأخر شوي المندوب" }
      ]
    },
    { name: "علي حسن", text: { ar: "صدقوني يا اخوان اللي يعاني من سرعة القذف هذا هو الحل السحري والنهائي." }, stars: 5 },
    { name: "نواف الدوسري", text: { ar: "كنت خايف أدفع أونلاين بس لما شفت الدفع عند الاستلام ارتحت وطلبت، والمنتج جبار." }, stars: 5 },
    { name: "إبراهيم السعيد", text: { ar: "يعطي إحساس طبيعي جداً بدون أي تخدير مزعج مثل البخاخات الثانية في السوق." }, stars: 5 },
    { name: "زياد القحطاني", text: { ar: "الكمية في العبوة تكفي فترة طويلة، نقطتين فقط تعطي مفعول خيالي." }, stars: 5 },
    { name: "عبدالعزيز ص.", text: { ar: "طلبت عبوتين وعطوني خصم ممتاز، التجربة الأولى خيالية وأنصح فيه بقوة للمتزوجين." }, stars: 5 },
    { name: "عادل العوضي", text: { ar: "مفعول سريع ويبقى لساعات، رجع لي ثقتي بنفسي قدام زوجتي." }, stars: 5 },
    ...
    { name: "هشام الحربي", text: { ar: "النتيجة قوية لكن يحتاج مساج لمدة دقيقة كاملة عشان يمتصه الجلد صح." }, stars: 4 },
    { name: "بندر الجهني", text: { ar: "طلبت عبوتين ووصلتني في نفس اليوم، التوصيل أسرع مما توقعت." }, stars: 5 },
    ...
    { name: "سليمان الرشيدي", text: { ar: "النتيجة تفوق الوصف، لكن تمنيت لو في أحجام أكبر للعبوة." }, stars: 4 },
    ...
    { name: "حمدان البقمي", text: { ar: "يعطي نشاط وصلابة واضحة بدون ما يرهق القلب، وهذا المطلوب." }, stars: 5 },
    ...
    { name: "رامي ف.", text: { ar: "جودته عالية وتركيبته ناعمة على الجلد ما تسبب اي تهيج أو حرارة." }, stars: 5 },
    ...
    { name: "زهير م.", text: { ar: "العبوة حجمها مناسب وسهلة الاستخدام حتى في السفر." }, stars: 4 },
