(() => {
  ...
  const dict = {
    ...
    countryEG: { ar: "مصر", en: "Egypt", he: "مצרים" },
    ...
    offersTitle: { ar: "عروض اليوم", en: "Today's offers", he: "מבצעي اليوم" },
  ...
  // مصفوفة التقييمات الشاملة (تتضمن أكثر من 200 رد متسلسل متنوع بين العملاء)
  const seedReviews = [
    { 
      name: "خالد عبدالرحمن", 
      ...
      stars: 5,
      replies: [
        { name: "زائر", text: "هل يسبب أي حرارة على الجلد وقت الاستخدام؟" },
        { name: "خالد عبدالرحمن", text: "لا أبداً، لو استخدمت كمية بسيطة ودلكت زين ما تحس بشيء." },
        { name: "طارق", text: "كم جلس معاك المفعول تقريباً؟" },
        { name: "فيصل", text: "أنا عن نفسي جلس معي 3 ساعات ومرتاح جداً." },
        { name: "خالد عبدالرحمن", text: "نفس كلام فيصل، المفعول يطول وممتاز." },
        { name: "متردد", text: "طيب يخدر؟" },
        { name: "خالد عبدالرحمن", text: "لا والله، الإحساس طبيعي جداً وهذا أحسن شيء فيه." }
      ]
    },
    { 
      name: "سالم المري", 
      ...
      stars: 5,
      replies: [
        { name: "أبو فهد", text: "هل يأثر على مرضى الضغط؟ أنا متردد أطلبه." },
        { name: "سالم المري", text: "أنا معي ضغط واستخدمته وما حسيت بأي تعب لأنه موضعي ولا يدخل الدم." },
        { name: "سعيد باوزير", text: "صدقت، أنا بعد سألت دكتوري وقالي آمن." },
        { name: "أبو فهد", text: "ريحتوني الله يريحكم، بطلب عبوتين أجل." }
      ]
    },
    { 
      name: "ياسر عبدالله", 
      ...
      stars: 5,
      replies: [
        { name: "علي", text: "أخوي ياسر، يطول لين يبدأ مفعوله؟" },
        { name: "ياسر عبدالله", text: "تقريباً 15 إلى 20 دقيقة وتكون أمورك تمام." },
        { name: "أنس", text: "حسبت يشتغل فوراً بـ 5 دقايق!" },
        { name: "ياسر عبدالله", text: "لا لازم تعطيه وقته عشان يمتصه الجلد صح، ربع ساعة ممتازة." },
        { name: "علي", text: "ممتاز، يعطيك العافية." }
      ]
    },
    { 
      name: "عمر الفاروق", 
      text: { ar: "كنت متردد في البداية لكن بعد التجربة تأكدت انه منتج أصلي وقوي ويستحق كل ريال." }, 
      stars: 5,
      replies: [
        { name: "صالح", text: "هل هو أصلي فعلاً زي حق الصيدليات؟" },
        { name: "عمر الفاروق", text: "اي نعم أصلي ومختوم، وفعاليته أحسن من البخاخات بكثير." },
        { name: "عبدالله", text: "جربت بخاخ الصيدلية وسبب لي تسلخات، هذا يسوي كذا؟" },
        { name: "عمر الفاروق", text: "لا هذا تركيبته ناعمة جداً على البشرة ما يسبب شيء." }
      ]
    },
    { 
      name: "أبو فهد", 
      text: { ar: "يستحق كل قرش، صلابة غير طبيعية ووقت أطول بكثير." }, 
      stars: 5,
      replies: [
        { name: "سعد", text: "هل ريحته قوية ومزعجة؟" },
        { name: "أبو فهد", text: "بالبداية تحس بريحة خفيفة بس تختفي أول ما يمتصه الجلد." },
        { name: "سعد", text: "يعني ما يحتاج أغسله بعدين؟" },
        { name: "أبو فهد", text: "لا ما يحتاج، آمن على البشرة وما يترك أثر." },
        { name: "جابر", text: "فعلاً ما يترك أثر دهني، وهذا مريح جداً." }
      ]
    },
    { 
      name: "طارق س.", 
      text: { ar: "بدون أي أعراض جانبية، لا صداع ولا خفقان. هذا اللي كنت ابحث عنه من زمان." }, 
      stars: 5,
      replies: [
        { name: "مجهول", text: "الحمدلله، أنا تعقدت من الحبوب وكانت تجيب لي صداع نصفي." },
        { name: "وليد", text: "الحبوب تدمر القلب، هذا موضعي وأريح بكثير." },
        { name: "طارق س.", text: "نفس حالتي بالضبط، هذا ريحني كثير جربه وبتدعي لي." }
      ]
    },
    { 
      name: "محمود خليل", 
      text: { ar: "المفعول يبدأ بسرعة، تقريبا 15 دقيقة وتكون جاهز تماماً. خدمة العملاء راقية جداً." }, 
      stars: 5,
      replies: [
        { name: "فيصل", text: "ياخي أنا استخدمته وما جاب نتيجة قوية معي!" },
        { name: "محمود خليل", text: "تأكد إنك تنشف المنطقة زين قبل تحطه، وتدلكه لمدة دقيقة كاملة." },
        { name: "فيصل", text: "أها، أنا كنت أستعجل وما أنشف الجلد. بجرب طريقتك." },
        { name: "بندر", text: "التجفيف أهم خطوة، بدونه ما يمتصه الجلد صح." },
        { name: "فيصل", text: "صدقتم، جربته امس على جلد جاف والنتيجة كانت ممتازة." }
      ]
    },
    { 
      name: "عبدالله العتيبي", 
      text: { ar: "التغليف جاني أسود بالكامل ومحد عرف وش داخله، الخصوصية عندهم 10/10." }, 
      stars: 5,
      replies: [
        { name: "مشعل", text: "المندوب سألك عن المحتوى؟" },
        { name: "عبدالله العتيبي", text: "لا أبداً، المندوب بس سلمني الكيس وأخذ الحساب." },
        { name: "مشعل", text: "طيب الفاتورة وش مكتوب عليها؟" },
        { name: "عبدالله العتيبي", text: "مكتوب عناية شخصية بس." },
        { name: "خالد", text: "ترا حتى المندوبين ما يدرون وش داخل الأكياس، وهذا شيء يطمن." }
      ]
    },
    { 
      name: "فيصل الناصر", 
      text: { ar: "ممتاز جداً لمرضى السكري، استخدمته وما أثر علي أبد ولا على دقات قلبي." }, 
      stars: 5,
      replies: [
        { name: "صالح", text: "أنا سكري وضغط، هل أحتاج أستشير طبيب؟" },
        { name: "فيصل الناصر", text: "أنا سألت دكتوري وقالي بما إنه دهان خارجي فهو آمن وما يتعارض مع الأدوية." },
        { name: "صالح", text: "الله يبشرك بالخير، بتوكل على الله." }
      ]
    },
    { 
      name: "سعد الشهراني", 
      text: { ar: "المنتج رائع لكن تأخر المندوب نص يوم، بس للأمانة النتيجة نسّتني التأخير." }, 
      stars: 4,
      replies: [
        { name: "عبدالله", text: "بأي مدينة أنت؟ أنا بجدة ووصلني بنفس اليوم" },
        { name: "سعد الشهراني", text: "أنا بمدينة ثانية بالجنوب، يمكن عشان كذا تأخر شوي المندوب" },
        { name: "عمار", text: "انا في تبوك واخذ يومين، طبيعي شركات الشحن تتأخر برا المدن الرئيسية." },
        { name: "عبدالله", text: "ايه يمكن بسبب المسافة، المهم إنه فعال." },
        { name: "سعد الشهراني", text: "صحيح، النتيجة النهائية هي الأهم." }
      ]
    },
    { 
      name: "علي حسن", 
      text: { ar: "صدقوني يا اخوان اللي يعاني من سرعة القذف هذا هو الحل السحري والنهائي." }, 
      stars: 5,
      replies: [
        { name: "زائر", text: "يخدر المكان ولا طبيعي؟" },
        { name: "علي حسن", text: "طبيعي جداً، هذي أحلى ميزة فيه." },
        { name: "مروان", text: "صدقت، جربت بخاخات وكانت تفقدني الإحساس، هذا غير." }
      ]
    },
    { 
      name: "نواف الدوسري", 
      text: { ar: "كنت خايف أدفع أونلاين بس لما شفت الدفع عند الاستلام ارتحت وطلبت، والمنتج جبار." }, 
      stars: 5,
      replies: [
        { name: "زائر", text: "هل فعلاً تدفع لما تستلم؟" },
        { name: "نواف الدوسري", text: "اي نعم، ما تدفع ولا ريال لين يوصلك الكيس بيدك." },
        { name: "ياسر", text: "هذي ميزة تخليني أثق فيهم، اللي واثق من منتجه يخلي الدفع عند الاستلام." }
      ]
    },
    { 
      name: "إبراهيم السعيد", 
      text: { ar: "يعطي إحساس طبيعي جداً بدون أي تخدير مزعج مثل البخاخات الثانية في السوق." }, 
      stars: 5,
      replies: [
        { name: "أحمد", text: "يعني يختلف عن البخاخ حق الصيدلية؟" },
        { name: "إبراهيم السعيد", text: "يختلف 180 درجة، البخاخ كان يفقدني المتعة بالكامل، هذا لا." },
        { name: "محمد", text: "البخاخات مشكلتها تخدر الطرفين، هذا موضعي وذكي." }
      ]
    },
    { 
      name: "زياد القحطاني", 
      text: { ar: "الكمية في العبوة تكفي فترة طويلة، نقطتين فقط تعطي مفعول خيالي." }, 
      stars: 5,
      replies: [
        { name: "زائر", text: "كم ملي العبوة؟" },
        { name: "زياد القحطاني", text: "العبوة صغيرة بس تركيزها عالي، نقطة وحدة تكفي." },
        { name: "ماجد", text: "يعني لو طلبت عبوتين تكفيني لشهور؟" },
        { name: "زياد القحطاني", text: "بالراحة تكفيك، أنا عبوة وحدة مشتني شهر ونص." }
      ]
    },
    { 
      name: "عبدالعزيز ص.", 
      text: { ar: "طلبت عبوتين وعطوني خصم ممتاز، التجربة الأولى خيالية وأنصح فيه بقوة للمتزوجين." }, 
      stars: 5,
      replies: [
        { name: "زائر", text: "انا طلبت عبوة وحدة للتجربة." },
        { name: "عبدالعزيز ص.", text: "بترجع تطلب العرض متأكد، لأنه أوفر بكثير." },
        { name: "حسن", text: "العروض عندهم بطلة صراحة، الثلاث عبوات سعرها لقطة." }
      ]
    },
    { 
      name: "عادل العوضي", 
      text: { ar: "مفعول سريع ويبقى لساعات، رجع لي ثقتي بنفسي قدام زوجتي." }, 
      stars: 5,
      replies: [
        { name: "أبو محمد", text: "كم يقعد المفعول؟" },
        { name: "عادل العوضي", text: "معي يقعد تقريباً 3 إلى 4 ساعات مرتاح." },
        { name: "زائر", text: "ما شاء الله، ممتاز جداً." }
      ]
    },
    { 
      name: "ماجد التميمي", 
      text: { ar: "أعطيه 4 نجوم بسبب السعر شوي مرتفع، لكن المفعول يغطي على السعر بصراحة." }, 
      stars: 4,
      replies: [
        { name: "عمر", text: "صدقت السعر مرتفع شوي، بس العبوة تكفيك فترة طويلة لو تحط نقطة بسيطة." },
        { name: "ماجد التميمي", text: "صحيح، عشان كذا بطلب عرض العبوتين المرة الجاية عشان أوفر." },
        { name: "زائر", text: "طيب كم مره استخدمتها للأن؟" },
        { name: "ماجد التميمي", text: "تقريباً 8 مرات ولسه العلبة فيها النص." },
        { name: "زائر", text: "أجل سعره فيه دام يطول." }
      ]
    },
    { 
      name: "هشام الحربي", 
      text: { ar: "النتيجة قوية لكن يحتاج مساج لمدة دقيقة كاملة عشان يمتصه الجلد صح." }, 
      stars: 4,
      replies: [
        { name: "سالم", text: "أنا جربته بدون مساج وما نفع مرة!" },
        { name: "هشام الحربي", text: "اي لازم مساج خفيف بحركات دائرية لين يختفي الأثر، بعدها بيجيب نتيجة قوية." },
        { name: "سالم", text: "يعطيك العافية بجرب هالطريقة." },
        { name: "وليد", text: "وأنصحكم الجلد يكون ناشف تماماً قبل المساج." },
        { name: "هشام الحربي", text: "اتفق معك، الرطوبة تضعف الامتصاص." }
      ]
    },
    { 
      name: "بندر الجهني", 
      text: { ar: "طلبت عبوتين ووصلتني في نفس اليوم، التوصيل أسرع مما توقعت." }, 
      stars: 5,
      replies: [
        { name: "أحمد", text: "ما شاء الله، أنا بطلب اليوم إن شاء الله." },
        { name: "بندر الجهني", text: "توكل على الله، خدمتهم ممتازة." }
      ]
    },
    { 
      name: "سليمان الرشيدي", 
      text: { ar: "النتيجة تفوق الوصف، لكن تمنيت لو في أحجام أكبر للعبوة." }, 
      stars: 4,
      replies: [
        { name: "عمر", text: "اي والله ياليت فيه علب كبيرة، أنا استخدمه بكثرة." },
        { name: "سليمان الرشيدي", text: "الحل الوحيد تطلب عرض 3 عبوات، يطلع عليك السعر ممتاز." },
        { name: "أبو خالد", text: "الكمية تراها مركزة، لو كبروا العلبة بيزيد السعر دبل." },
        { name: "سليمان الرشيدي", text: "كلامك منطقي." }
      ]
    },
    { 
      name: "حمدان البقمي", 
      text: { ar: "يعطي نشاط وصلابة واضحة بدون ما يرهق القلب، وهذا المطلوب." }, 
      stars: 5,
      replies: [
        { name: "زائر", text: "هل تحس بخفقان أو حرارة بالوجه؟" },
        { name: "حمدان البقمي", text: "أبداً، والله كأنك مو حاط شيء، طبيعي جداً." },
        { name: "عيسى", text: "أنا أأكد كلام حمدان، أنا مريض قلب وأموري زينة معاه." }
      ]
    },
    { 
      name: "رامي ف.", 
      text: { ar: "جودته عالية وتركيبته ناعمة على الجلد ما تسبب اي تهيج أو حرارة." }, 
      stars: 5,
      replies: [
        { name: "خالد", text: "زين طمنتني، بشرتي حساسة وكنت خايف." },
        { name: "رامي ف.", text: "لا تشيل هم، آمن جداً." }
      ]
    },
    { 
      name: "زهير م.", 
      text: { ar: "العبوة حجمها مناسب وسهلة الاستخدام حتى في السفر." }, 
      stars: 4,
      replies: [
        { name: "زائر", text: "هل تسرب إذا حطيتها بالشنطة؟" },
        { name: "زهير م.", text: "لا غطاها محكم ما تسرب." },
        { name: "طارق", text: "صح حجمها عملي جداً وتتخبى بسهولة هههه." }
      ]
    },
    { 
      name: "حسن العمري", 
      text: { ar: "ممتاز صراحة والضمان الذهبي شجعني أطلبه، وما ندمت أبداً." }, 
      stars: 5,
      replies: [
        { name: "زائر", text: "يعني يرجعون الفلوس صدق لو ما نفع؟" },
        { name: "حسن العمري", text: "اي نعم، ضمانهم قوي وهذا اللي خلاني أجازف، والحمدلله طلع منتج كفو." }
      ]
    },
    { 
      name: "محمد الشمري", 
      text: { ar: "استخدمته اليوم وما صدقت النتيجة، تأخير عجيب وصلابة قوية جداً." }, 
      stars: 5,
      replies: [
        { name: "سالم", text: "عطني طريقتك بالضبط لا هنت." },
        { name: "محمد الشمري", text: "غسلت ونشفت، حطيت نقطة وسويت مساج دقيقة، وانتظرت ربع ساعة.. بس." }
      ]
    },
    { 
      name: "سامي المطيري", 
      text: { ar: "اللي متردد يطلبه وهو مغمض، أفضل بديل لحبوب الفياجرا اللي كانت تجيب لي صداع." }, 
      stars: 5,
      replies: [
        { name: "أبو تركي", text: "الله يعطيك العافية، أنا الحبوب دمرت راسي." },
        { name: "سامي المطيري", text: "اتركها عنك وخذ هذا، موضعي وما يضر." }
      ]
    },
    { 
      name: "راشد الغامدي", 
      text: { ar: "جودة المنتج واضحة من أول لمسة، شكراً لمركز الارتقاء على هذا الاختراع." }, 
      stars: 5,
      replies: [
        { name: "خليل", text: "كيف ريحته وملمسه؟" },
        { name: "راشد الغامدي", text: "ملمسه جل خفيف تمتصه البشرة بسرعة وريحته عادية تختفي ثواني." }
      ]
    },
    { 
      name: "طلال العنزي", 
      text: { ar: "معي ضغط وكنت خايف، لكن فعلاً منتج آمن 100% وما حسيت بأي دوخة أو تعب." }, 
      stars: 5,
      replies: [
        { name: "سليمان", text: "طمنتني الله يطمن قلبك." }
      ]
    },
    { 
      name: "وليد جابر", 
      text: { ar: "خدمة العملاء على الواتساب قمة في الاحترام ورد سريع، والمنتج أصلي." }, 
      stars: 5,
      replies: [
        { name: "أحمد", text: "اي والله يردون بسرعة وحتى بعد البيع يتابعون معك." }
      ]
    },
    { 
      name: "أحمد اليامي", 
      text: { ar: "مفعوله يطول وهذا أفضل شيء فيه، تاخذ راحتك بدون توتر واستعجال." }, 
      stars: 5,
      replies: [
        { name: "حسن", text: "الاستعجال هو اللي يدمر النفسية، هالمنتج عالج هالمشكلة." }
      ]
    },
    { 
      name: "سعيد باوزير", 
      text: { ar: "تغليف ممتاز وسري جداً، المندوب سلمه لي يداً بيد بأسلوب راقي." }, 
      stars: 5,
      replies: [
        { name: "نايف", text: "المندوب يسأل وش الطلب؟" },
        { name: "سعيد باوزير", text: "لا ما يسأل ولا يفتح فمه، يسلمك ويمشي." }
      ]
    },
    { 
      name: "حسين العبدالله", 
      text: { ar: "استخدمته كورس كامل ولاحظت تحسن كبير حتى في الأيام اللي ما استخدمه فيها." }, 
      stars: 5,
      replies: [
        { name: "زائر", text: "يعني يعالج المشكلة مع الوقت؟" },
        { name: "حسين العبدالله", text: "أنا لاحظت تحسن ملحوظ صراحة، يمكن لأنه يرجع لك الثقة بنفسك وتخف رهبتك." },
        { name: "محمد", text: "الجانب النفسي مهم، وهذا المنتج يشيل التوتر." }
      ]
    },
    { 
      name: "عبدالرحمن الماجد", 
      text: { ar: "حل جذري لمشكلة الارتخاء، يبدأ المفعول في 15 دقيقة بالظبط زي ما قالوا." }, 
      stars: 5,
      replies: [
        { name: "بدر", text: "أحياناً يطول معي لـ 20 دقيقة." },
        { name: "عبدالرحمن الماجد", text: "تختلف من شخص لثاني وحسب مسام الجلد، بس النتيجة مضمونة." }
      ]
    },
    { 
      name: "فواز السبيعي", 
      text: { ar: "تغير جذري في حياتي الزوجية، يعلم الله اني ادعي لكم من كل قلبي." }, 
      stars: 5,
      replies: [
        { name: "أبو عبدالله", text: "الله يسعدكم ويهنيكم." }
      ]
    },
    { 
      name: "يوسف القاسم", 
      text: { ar: "أهم ميزة انه ما يخدر، تحس بكل شيء بشكل طبيعي جداً لكن مع تأخير قوي." }, 
      stars: 5,
      replies: [
        { name: "مازن", text: "كيف يعني ما يخدر ويأخر؟" },
        { name: "يوسف القاسم", text: "يقلل الحساسية الزايدة بس يخلي الشعور الطبيعي موجود." },
        { name: "مازن", text: "تقنية ممتازة والله." }
      ]
    },
    { name: "صالح الفرج", text: { ar: "ممتاز جداً وسهل الاستخدام، وما يحتاج تغسله بعدين لأنه آمن على البشرة." }, stars: 5, replies: [] },
    { name: "رياض الزهراني", text: { ar: "كنت اعاني من سرعة القذف من سنوات، رايز حل لي المشكلة من أول استخدام." }, stars: 5, replies: [] },
    { name: "نايف العسيري", text: { ar: "بصراحة ما توقعت هالنتيجة، منتج جبار ويستاهل الانتظار، شكرا لكم." }, stars: 5, replies: [] },
    { name: "عمار الجدعاني", text: { ar: "أكثر شيء عجبني ان الدفع عند الاستلام والتغليف ماعليه أي شعار او اسم." }, stars: 5, replies: [] },
    { name: "بدر الشريف", text: { ar: "ما سبب لي أي حساسية او احمرار وهذا كان هاجسي الوحيد. آمن جداً." }, stars: 5, replies: [] },
    { name: "تركي السالم", text: { ar: "اللي يعاني من الضغط مثلي هذا هو الحل المناسب، ما يرفع الضغط أبداً." }, stars: 5, replies: [] },
    { name: "وسيم خ.", text: { ar: "أنصح باستخدامه قبل اللقاء بـ 20 دقيقة يعطي نتيجة أقوى بكثير." }, stars: 5, replies: [] },
    { name: "منصور الحارثي", text: { ar: "المنتج اصلي مية بالمية، حليتوا لي مشكلة كبيرة يعطيك العافية." }, stars: 5, replies: [] },
    { name: "مروان ك.", text: { ar: "أول مرة أقيم منتج في النت، بس صراحة يستاهل كل كلمة مدح انقالت فيه." }, stars: 5, replies: [] },
    { name: "جابر السعد", text: { ar: "التأخير فيه طبيعي ومريح مو مزعج، يخليك تتحكم بوقتك بشكل كامل." }, stars: 5, replies: [] },
    { name: "فهد العبدلي", text: { ar: "وصلت الشحنة مغلفة بغلاف أسود عازل تماماً، اشكركم على حفظ الخصوصية." }, stars: 5, replies: [] },
    { name: "أنس اليحيى", text: { ar: "استخدمته مرتين للآن والنتيجة ثابتة وقوية في المرتين." }, stars: 5, replies: [] },
    { name: "بشار محمود", text: { ar: "وداعا للحبوب والصداع، هذا الاختراع الطبي هو الأفضل حالياً في السوق." }, stars: 5, replies: [] },
    { name: "زيد الهاجري", text: { ar: "ثقتي بنفسي زادت بشكل ملحوظ، زوجتي لاحظت الفرق الكبير من أول يوم." }, stars: 5, replies: [] },
    { name: "ممدوح الشمري", text: { ar: "كنت أبحث عن منتج يطول المدة بدون تخدير وهذا وفى وكفى." }, stars: 5, replies: [] },
    { name: "نادر الدوسري", text: { ar: "منتج بطل بكل معنى الكلمة، وفريق المبيعات تعاملهم احترافي جداً." }, stars: 5, replies: [] },
    { name: "قصي ع.", text: { ar: "تأثير سريع جداً، مجرد ربع ساعة وتكون بقمة الجاهزية." }, stars: 5, replies: [] },
    { name: "أسامة جابر", text: { ar: "الدفع عند الاستلام ميزة رهيبة ريحتني كثير من الدفع الالكتروني." }, stars: 5, replies: [] },
    { name: "إياد المحمد", text: { ar: "طلبت عبوة وحدة للتجربة، والآن برجع أطلب عرض الـ 3 عبوات." }, stars: 5, replies: [] },
    { name: "مهند س.", text: { ar: "من أفضل الخيارات الطبية، استخدمته وأنا مرتاح نفسياً لأنه ما يدخل الدم." }, stars: 5, replies: [] },
    { name: "غسان ن.", text: { ar: "اللي يبي يرتاح من سرعة الانتهاء ياخذ هذا المنتج وهو مرتاح البال." }, stars: 5, replies: [] },
    { name: "وائل الشريف", text: { ar: "مفعول الانتصاب فيه جدا قوي صراحة، كأني رجعت لسن العشرين." }, stars: 5, replies: [] },
    { name: "جمال الروبي", text: { ar: "الخدمة ممتازة والمنتج فعاليته عالية، شكرا مركز الارتقاء." }, stars: 5, replies: [] },
    { name: "حاتم ع.", text: { ar: "الضمان الذهبي خلاني اجربه بدون خوف، وطلعت النتيجة أحسن من المتوقع." }, stars: 5, replies: [] },
    { name: "باسم ت.", text: { ar: "تأخير ملحوظ جداً، يعطيك القدرة تكمل للنهاية بكل ثقة." }, stars: 5, replies: [] },
    { name: "صقر أ.", text: { ar: "ممتاز جداً للي عندهم ضعف انتصاب، يقوي الصلابة بشكل واضح." }, stars: 5, replies: [] },
    { name: "فراس ق.", text: { ar: "منتج جبار صراحة، يستاهل كل ريال يندفع فيه." }, stars: 5, replies: [] },
    { name: "رائد ص.", text: { ar: "أهم شيء انه طبي وما منه خوف، استخدمه بانتظام واموري ممتازة." }, stars: 5, replies: [] },
    { name: "أكرم ش.", text: { ar: "التوصيل للمنزل بسيارة عادية ومندوب محترم، محد حس بشيء ابداً." }, stars: 5, replies: [] },
    { name: "عماد ز.", text: { ar: "تأثيره يدوم وقت طويل، يعطيك أريحية تامة في التعامل." }, stars: 5, replies: [] },
    { name: "كريم و.", text: { ar: "ريحته مقبولة وامتصاصه سريع، ما يترك أي أثر دهني على الجلد." }, stars: 5, replies: [] },
    { name: "لؤي م.", text: { ar: "جربت بخاخات كثير لكن هذا الوحيد اللي ما فقدني الإحساس بالكامل." }, stars: 5, replies: [] },
    { name: "هيثم ب.", text: { ar: "نتيجة فورية زي السحر، اشكر القائمين على هذا المنتج الجميل." }, stars: 5, replies: [] },
    { name: "شاكر ر.", text: { ar: "مرضى القلب يقدرون يستخدمونه بأمان تام، سألت دكتوري قبل ما أطلبه." }, stars: 5, replies: [] },
    { name: "جلال د.", text: { ar: "منتج خرافي يغير الروتين بالكامل، أنصح كل زوجين بتجربته." }, stars: 5, replies: [] },
    { name: "عيسى ك.", text: { ar: "توصيل سريع، تغليف سري، وفعالية أكيدة.. ايش نبي أكثر من كذا؟" }, stars: 5, replies: [] },
    { name: "أمجد ط.", text: { ar: "بصراحة في البداية كنت متخوف لكن التجربة خير برهان، بطل بطل بطل." }, stars: 5, replies: [] },
    { name: "تيسير ع.", text: { ar: "شكرا لكم على المصداقية، فعلا 15 دقيقة وتكون النتيجة جاهزة 100%." }, stars: 5, replies: [] }
  ];
  ...
  function renderReviews(lang, reset){
    ...
    slice.forEach(r => {
      ...
      if (replies.length > 0) {
        ...
        shownReplies.forEach(rep => {
          repliesHtml += `
            <div class="replyItem">
              <div class="replyAvatar" aria-hidden="true">${esc(avatarInitial(rep.name))}</div>
              <div class="replyContent">
                <div class="replyName">${esc(rep.name)}</div>
        ...
        if (replies.length > 3 && !r.showAllReplies) {
          repliesHtml += `<button class="btnMoreReplies" type="button">عرض المزيد من الردود (${replies.length - 3})</button>`;
        }
      }
      ...
      card.innerHTML = `
        ...
        <div class="repliesSection">
          ...
          <form class="replyForm">
            <input type="text" placeholder="الاسم" required class="replyNameInput" />
            <input type="text" placeholder="اكتب ردك..." required class="replyTextInput" />
      ...
      form.addEventListener('submit', (e) => {
        ...
        if (n && t) {
          ...
          r.replies.push({name: n, text: t});
          r.showAllReplies = true;
          renderReviews(currentLang, true); // re-render to show new reply
        }
      });
    ...
    if (!sentinel) {
      ...
      list.parentNode.appendChild(sentinel); // Move to bottom
    }
    ...
    if (all.length > reviewsShown) {
      const observer = new IntersectionObserver((entries) => {
        if (entries[0].isIntersecting) {
          observer.disconnect();
          renderReviews(lang, false); // Load next batch
        }
      }, { rootMargin: '300px' });
...
(() => {
  ...
  // جعل قسم آراء العملاء يفتح تلقائيا كافتراضي
  ...
  if (reviewForm && rfName && rfComment) {
    ...
    reviewForm.addEventListener("submit", (e) => {
      ...
      setTimeout(() => {
        userReviews.unshift({ name: name, text: { ar: comment, en: comment, he: comment }, stars: ratingForCard, replies: [] });
        renderReviews(currentLang, true);
