(() => {
  ...
  const seedReviews = [
    // --- 20 Medical Consultations & Mixed Previous Reviews ---
    ...
    { name: { ar: "خالد عبدالرحمن", en: "Khaled A." }, text: { ar: "نتيجة خرافية من أول استخدام، انصح فيه وبشدة! فعلاً غير حياتي للأفضل." }, stars: 5, replies: [ { name: { ar: "زائر" }, text: { ar: "هل يسبب أي حرارة على الجلد وقت الاستخدام؟" } }, { ...docs.tariq, text: { ar: "لا أبداً أخي خالد، لو استخدمت كمية بسيطة ودلكت جيداً فلن تشعر بأي حرارة أو إزعاج." } } ] },
    { name: { ar: "سالم الشمري", en: "Salem S." }, text: { ar: "سمعت إنه يخدر المنطقة تماماً لدرجة إنك ما تحس بشيء.. هل هذا صحيح؟" }, stars: 5, replies: [ { ...docs.mahmoud, text: { ar: "هذا هو الفرق الجوهري بين رايز والبخاخات التجارية أخي سالم. رايز لا يحتوي على ليدوكائين مخدر، بل يعمل بتقنية ذكية تخفف الحساسية المفرطة فقط، لتستمتع بالإحساس الطبيعي بالكامل." } } ] },
    { name: { ar: "يوسف خليل", en: "Yousef K." }, text: { ar: "كم يدوم المفعول بالضبط؟ وهل لازم اغسله قبل اللقاء؟" }, stars: 5, replies: [ { ...docs.tariq, text: { ar: "المفعول الفعلي يبدأ خلال 15 دقيقة ويمتد لساعات لضمان راحتك التامة. ولا داعي لغسله أبداً لأن الجلد يمتصه بالكامل دون ترك أي أثر أو لزوجة." } } ] },
    ...
    { name: { ar: "فهد العتيبي", en: "Fahad A." }, text: { ar: "هل استخدامه باستمرار يسبب تعود؟ يعني هل ممكن بعدين ما اقدر بدونه؟" }, stars: 5, replies: [ { ...docs.rami, text: { ar: "سؤال ممتاز فهد. التركيبة آمنة للاستخدام المتكرر ولا تسبب أي إدمان عضوي أو تعود. يمكنك إيقافه في أي وقت والاعتماد عليه فقط عند الحاجة." } } ] },
    { name: { ar: "عبدالإله", en: "Abdulelah" }, text: { ar: "عمري 62 سنة، هل سيفيدني أم أنه مخصص للشباب فقط؟" }, stars: 5, replies: [ { ...docs.tariq, text: { ar: "المنتج فعال ومناسب للأعمار المتقدمة أخي عبدالإله. شريحة كبيرة من عملائنا فوق الستين ويحققون نتائج ممتازة في استعادة الصلابة." } } ] },
    ...
    { name: { ar: "تركي", en: "Turki" }, text: { ar: "أنا استخدمت كريمات ثانية وسببت لي صداع واحمرار بالوجه.. هل هذا نفس الشيء؟" }, stars: 5, replies: [ { ...docs.mahmoud, text: { ar: "لا أبداً أخي تركي. الصداع والاحمرار يحدث مع الحبوب الكيميائية، أما رايز فهو موضعي وآمن تماماً ولن تشعر بأي عرض جانبي." } } ] },
    ...
    { name: { ar: "عادل", en: "Adel" }, text: { ar: "هل ريحته قوية؟ زوجتي تنزعج من الروائح الطبية." }, stars: 4, replies: [ { ...docs.rami, text: { ar: "التركيبة شبه خالية من الروائح النفاذة. قد تلاحظ رائحة خفيفة تختفي فوراً بمجرد أن يمتصه الجلد." } } ] },
    { name: { ar: "محمد الزهراني", en: "Mohammed Z." }, text: { ar: "إذا طلبته، كيف تضمنون لي السرية؟ المندوب بيعرف وش داخل الكيس؟" }, stars: 5, replies: [ { ...docs.tariq, text: { ar: "نلتزم بسرية تامة. يتم الشحن في كيس أسود مبهم تماماً ومختوم، وحتى المندوب لا يعرف محتوى الشحنة إطلاقاً." } } ] },
    ...
    { name: { ar: "وليد", en: "Waleed" }, text: { ar: "أعاني من سرعة شديدة جداً (أقل من دقيقة)، هل سيعالج هذه المشكلة؟" }, stars: 5, replies: [ { ...docs.tariq, text: { ar: "نعم وليد، التركيبة مصممة خصيصاً لهذه الحالات. ستلاحظ مضاعفة كبيرة في الوقت تمنحك السيطرة والثقة." } } ] },
    ...
    { name: { ar: "بدر", en: "Bader" }, text: { ar: "الكمية في العبوة كم تكفي تقريباً؟ السعر شوي مرتفع." }, stars: 4, replies: [ { ...docs.rami, text: { ar: "العبوة اقتصادية جداً أخي بدر. تحتاج لكمية بسيطة، لذا العبوة الواحدة تكفي حتى 30 استخداماً." } } ] },
    { name: { ar: "أحمد الدوسري", en: "Ahmed D." }, text: { ar: "هل يسبب أي حرارة أو لسعة على الجلد وقت الاستخدام؟" }, stars: 5, replies: [ { ...docs.mahmoud, text: { ar: "التركيبة لطيفة جداً على البشرة. قد تشعر بانتعاش خفيف جداً يثبت بدء الفعالية دون أي لسع مزعج." } } ] },
    ...
    { name: { ar: "ماجد", en: "Majed" }, text: { ar: "هل الضمان الذهبي حقيقي فعلاً؟ لو ما نفعني ترجعون فلوسي؟" }, stars: 5, replies: [ { ...docs.tariq, text: { ar: "ضماننا حقيقي 100% أخي ماجد. ثقتنا تجعلنا نتحمل كامل المخاطرة واسترداد المال فوري بدون أسئلة." } } ] },
    { name: { ar: "زياد", en: "Ziad" }, text: { ar: "هل يؤثر على الطرف الآخر (الزوجة)؟" }, stars: 5, replies: [ { ...docs.rami, text: { ar: "إذا التزمت بالطريقة الصحيحة بالانتظار 15 دقيقة حتى يمتصه الجلد، فلن ينتقل أي أثر." } } ] },
    ...
    { name: { ar: "سعد", en: "Saad" }, text: { ar: "متى أحط المنتج بالضبط؟" }, stars: 5, replies: [ { ...docs.mahmoud, text: { ar: "فضل وضعه قبل اللقاء بـ 15 إلى 20 دقيقة على منطقة نظيفة ومجففة جيداً." } } ] },
    ...
    { name: { ar: "عبدالله", en: "Abdullah" }, text: { ar: "هل أقدر استخدمه مع الفياجرا؟" }, stars: 4, replies: [ { ...docs.tariq, text: { ar: "لا حاجة لدمجه مع الحبوب أخي عبدالله. رايز يوفر لك الصلابة والتأخير بأمان ويغنيك عنها." } } ] },
    { name: { ar: "ناصر", en: "Nasser" }, text: { ar: "كم يوم ويوصلني الطلب؟ أنا بالرياض." }, stars: 5, replies: [ { ...docs.rami, text: { ar: "توصيلنا سريع جداً. في المدن الرئيسية نصلك خلال 24 إلى 48 ساعة عمل." } } ] },
    ...
    { name: { ar: "مروان", en: "Marwan" }, text: { ar: "كيف أدفع لكم؟ وهل الموقع آمن؟" }, stars: 5, replies: [ { ...docs.tariq, text: { ar: "دفعك آمن ومريح 100% عبر خدمة (الدفع عند الاستلام)." } } ] },
    { name: { ar: "خالد", en: "Khaled" }, text: { ar: "هل المنتج مسجل ومرخص؟" }, stars: 5, replies: [ { ...docs.mahmoud, text: { ar: "بكل تأكيد، المركز معتمد وخضع لفحوصات صارمة لضمان الجودة والأمان." } } ] }
  ];
  ...
  // --- Guarantee Smart Popup Logic (وقت ظهور أطول 10 ثوانٍ) ---
