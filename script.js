(() => {
  ...
  // 73 تقييمًا طبيعيًا ومدروسًا للعملاء
  const seedReviews = [
  ...
  function startTopBadgeAnimation() {
    ...
    setInterval(() => {
      ...
      }, 400); // إنتظار نصف ثانية حتى يتلاشى ثم تبديل النص
    }, 3500); // تبديل كل 3.5 ثانية
  }
  ...
  const setLang = (lang) => {
    ...
    currentLang = lang;
    updateTopBadgeText(lang); // تحديث نص الشارة للغة الحالية
